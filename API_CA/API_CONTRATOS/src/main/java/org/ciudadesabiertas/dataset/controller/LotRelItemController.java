...
@RestController
@Api(value="LotRelItem",description = "Conjunto de operaciones relacionadas con el conjunto de la relación entre Lote y Clasificación en Contratos", tags= {"Contratos - Lote y Clasificación"})
public class LotRelItemController extends GenericController implements CiudadesAbiertasController 
{
	public static final String LIST = "/contract/lotRelItem";
	
	public static final String SEARCH_DISTINCT = LIST+"/distinct";
	
	public static final String RECORD = "/contract/lotRelItem/{id}";
	
	public static final String TRANSFORM = "/contract/lotRelItem/transform";
	
	public static final String ADD = "/contract/lotRelItem";
	public static final String UPDATE = "/contract/lotRelItem/{id}";
	public static final String DELETE = "/contract/lotRelItem/{id}";

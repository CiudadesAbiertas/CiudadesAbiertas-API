...
public class Lot implements java.io.Serializable,  RDFModel {
	...
	@ApiModelProperty(value = "Nombre del lote. Ejemplo: Material diverso")
	@CsvBindByPosition(position=2)
	@CsvBindByName(column="title", format=Constants.STRING_FORMAT)
	@Rdf(contexto = Context.DCT, propiedad = "title")
	private String title;
	
	@ApiModelProperty(value = "Adjudicatario del lote. Ejemplo: AW1")
	...
	@ApiModelProperty(value = "Proceso de contratación del lote. Ejemplo: TN1")
	...
	@ApiModelProperty(value = "Valor del lote. Ejemplo: 131468.12")
	...
	@ApiModelProperty(value = "Descripción del lote. Ejemplo: Material diverso 1")

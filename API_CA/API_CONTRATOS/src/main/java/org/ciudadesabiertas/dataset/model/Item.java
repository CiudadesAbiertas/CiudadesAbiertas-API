...
public class Item implements java.io.Serializable,  RDFModel {
	...
	@ApiModelProperty(value = "Identificador de la clasificación. Ejemplo: C1")
	...
	@ApiModelProperty(value = "Descripción de la clasificación. Ejemplo: Artículos de ferretería")

...
@RestController
@Api(value="Lote de Contratación",description = "Conjunto de operaciones relacionadas con el conjunto de datos lotes de contratación en Contratos", tags= {"Contratos - Lote"})

...
@RestController
@Api(value="TenderRelItem",description = "Conjunto de operaciones relacionadas con el conjunto de la relación entre Pliego y Clasificación en Contratos", tags= {"Contratos - Pliego y Clasificación"})
public class TenderRelItemController extends GenericController implements CiudadesAbiertasController 
{
	public static final String LIST = "/contract/tenderRelItem";
	
	public static final String SEARCH_DISTINCT = LIST+"/distinct";
	
	public static final String RECORD = "/contract/tenderRelItem/{id}";
	
	public static final String TRANSFORM = "/contract/tenderRelItem/transform";
	
	public static final String ADD = "/contract/tenderRelItem";
	public static final String UPDATE = "/contract/tenderRelItem/{id}";
	public static final String DELETE = "/contract/tenderRelItem/{id}";

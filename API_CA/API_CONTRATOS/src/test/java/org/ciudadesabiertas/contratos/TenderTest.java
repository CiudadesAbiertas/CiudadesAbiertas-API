...
public class TenderTest {
	...
	private static final Logger log = LoggerFactory.getLogger(TenderTest.class);
	
	@Autowired
	private WebApplicationContext wac;

    @Autowired
    private DatasetService<Tender> service;
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<Tender> list = service.basicQuery(ContratosConstants.KEY,Tender.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("tenderController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(TenderController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test05_Add_NO_OK_400() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(TenderController.ADD)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(item))	
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(TenderController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(TenderController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(TenderController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(TenderController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(TenderController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(TenderController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(TenderController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (Tender.class).getDeclaredFields();
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(TenderController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(TenderController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    ...
    public void test23_List_Distinct_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(TenderController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(TenderController.LIST, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }
    
    @Test
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,TenderController.LIST);        

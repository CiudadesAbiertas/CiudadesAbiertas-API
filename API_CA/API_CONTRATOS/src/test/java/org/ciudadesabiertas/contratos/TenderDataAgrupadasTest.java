...
public class TenderDataAgrupadasTest
{	
	@Autowired
	...
	private String listURL=TenderController.SEARCHGROUP;
	...
	public void test_Busqueda_Agrupada_01() throws Exception
	{
		...
		String params="fields=mainProcurementCategory,sum(valueAmount)&group=mainProcurementCategory&sort=-sum(valueAmount)";

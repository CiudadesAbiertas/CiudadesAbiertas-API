...
public class LotRelItemTest {
	
	private static final Logger log = LoggerFactory.getLogger(LotRelItemTest.class);
	
	@Autowired
	private WebApplicationContext wac;

    @Autowired
    private DatasetService<LotRelItem> service;
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<LotRelItem> list = service.basicQuery(ContratosConstants.KEY,LotRelItem.class);
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(LotRelItemController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test05_Add_NO_OK_400() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(LotRelItemController.ADD)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(item))	
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(LotRelItemController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(LotRelItemController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(LotRelItemController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(LotRelItemController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(LotRelItemController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(LotRelItemController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(LotRelItemController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (LotRelItem.class).getDeclaredFields();
    ...
    public void test21_List_Sort_200() throws Exception {
    	String sort="?sort=-id,lot";
        this.mockMvc.perform(MockMvcRequestBuilders.get(LotRelItemController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(LotRelItemController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    ...
    public void test23_List_Distinct_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(LotRelItemController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(LotRelItemController.LIST, mockMvc);
    ...
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	...
    	String id ="0013496-19-LRI1";
    	id=Util.encodeURL(id);
    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(LotRelItemController.LIST+"/"+id, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

...
public class LotDataAgrupadasTest
{	
	@Autowired
	...
	private String listURL=LotController.SEARCHGROUP;
	...
	public void test_Busqueda_Agrupada_01() throws Exception
	{
		...
		String params="fields=title,sum(valueAmount)&group=title&sort=-sum(valueAmount)";

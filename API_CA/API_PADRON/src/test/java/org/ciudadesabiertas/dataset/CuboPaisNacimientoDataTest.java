...
public class CuboPaisNacimientoDataTest
{
	...
	private String listURL=CuboPaisNacimientoController.LIST;
	private String queryURL=CuboPaisNacimientoController.QUERY;
	...
	@Test
	public void test_Busqueda_pais_nacimiento() throws Exception
	{
	    String [] paramField= {"paisNacimiento","numeroPersonas"};
		String [] value = {"España","75321"};
		JSONArray records = TestUtils.extractRecords(listURL, paramField,  value, mockMvc);
		assertTrue(records.size() == 1);
	}
	...
	{   
		...
		String [] value = {"paisNacimiento","AVG","numeroPersonas"};           
    ...
    {	
    	String [] paramField= {"dimension","group","measure"};
		String [] value = {"paisNacimiento, refPeriod","AVG","numeroPersonas"};   
		JSONArray records = TestUtils.extractRecords(queryURL, paramField,  value, mockMvc);
		assertTrue(records.size() == 11);
    }
    ...
    {	
		...
		String [] value = {"paisNacimiento,refPeriod","AVG","numeroPersonas","refPeriod=2016"};   
		JSONArray records = TestUtils.extractRecords(queryURL, paramField,  value, mockMvc);
		assertTrue(records.size() == 11);
    }
    ...
    {			
		String [] paramField= {"dimension","group","measure","where"};
		String [] value = {"paisNacimiento,refPeriod,paisTitle","AVG","numeroPersonas","refPeriod=2016"};   
		JSONArray records = TestUtils.extractRecords(queryURL, paramField,  value, mockMvc);
		assertTrue(records.size() == 11);
    }

...
@RestController
@Api(value="Cubo Procedencia",description = "Conjunto de operaciones relacionadas con sobre el Cubo de Datos Procedencia de Padrón", tags= {"Padrón - Cubo de datos Procedencia"})

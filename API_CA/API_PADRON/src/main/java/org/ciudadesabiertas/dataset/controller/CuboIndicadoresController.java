...
@RestController
@Api(value="Cubo indicadores demográficos",description = "Conjunto de operaciones relacionadas con sobre el Cubo de Datos Indicadores Demográficos de Padrón", tags= {"Padrón - Cubo de datos Indicadores Demográficos"})

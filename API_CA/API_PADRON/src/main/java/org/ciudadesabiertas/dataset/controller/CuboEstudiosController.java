...
@Api(value="Cubo Estudios",description = "Conjunto de operaciones relacionadas con sobre el Cubo de Datos Nivel de Estudios de Padrón", tags= {"Padrón - Cubo de datos Estudios"})

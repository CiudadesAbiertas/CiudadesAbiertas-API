...
@RestController
@Api(value="Cubo Edad por Grupo Quinquenales",description = "Conjunto de operaciones relacionadas con sobre el Cubo de Datos Edad de Padrón", tags= {"Padrón - Cubo de datos Edad Grupos Quinquenales"})
public class CuboEdadGrupoQuinquenalController<T> extends GenericController implements CiudadesAbiertasController 
{
	public static final String QUERY = "/padron/datacube/edadGrupoQuinquenal/query";	
	public static final String LIST = "/padron/datacube/edadGrupoQuinquenal/observation";	
	public static final String RECORD = "/padron/datacube/edadGrupoQuinquenal/observation/{id}";

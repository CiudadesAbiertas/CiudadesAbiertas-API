...
public class CuboEstudiosDataTest
{
	...
	private String listURL=CuboEstudiosController.LIST;
	private String queryURL=CuboEstudiosController.QUERY;
	...
	{
		String [] paramField= {"refPeriod","tipoNivelEstudio"};
		String [] value = {"2016","42"};
		JSONArray records = TestUtils.extractRecords(listURL, paramField,  value, mockMvc);
		assertTrue(records.size() == 1);
	}	
    ...
    {	
    	String [] paramField= {"dimension","group","measure"};
		String [] value = {"refPeriod,tipoNivelEstudio","AVG","numeroPersonas"};   
		JSONArray records = TestUtils.extractRecords(queryURL, paramField,  value, mockMvc);
		assertTrue(records.size() == 72);
    }
    ...
    {	
		...
		String [] value = {"refPeriod,tipoNivelEstudio","AVG","numeroPersonas","numeroPersonas>80000"};   
		JSONArray records = TestUtils.extractRecords(queryURL, paramField,  value, mockMvc);

...
public class CuboProcedenciaDataTest
{
    ...
    {	
		...
		String [] value = {"refPeriod,edadGruposQuinquenales","AVG","numeroPersonas","refPeriod=2017"};   
		JSONArray records = TestUtils.extractRecords(queryURL, paramField,  value, mockMvc);

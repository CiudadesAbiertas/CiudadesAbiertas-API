...
public class DeudaComercialProperIntervalDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(DeudaComercialProperIntervalDataRSQLTest.class);
...
private String listURL = DeudaComercialProperIntervalController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "id=='2020-06'", 1 });
  params.add(new Object[] { "hasBeginning=='2020-06-01'", 1 });
  params.add(new Object[] { "hasEnd=='2020-06-30'", 1 });

...
public class DeudaFinancieraInstrumentoFinanciacionDataTest {

private static final Logger log = LoggerFactory.getLogger(DeudaFinancieraInstrumentoFinanciacionDataTest.class);

...
public class DeudaFinancieraCargaDataTest {

private static final Logger log = LoggerFactory.getLogger(DeudaFinancieraCargaDataTest.class);
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "description","AMORT.VTO.21/12/17 PTM L/P MDEC-I.C.O.(20,77MM)'06 (2017)", 1 });

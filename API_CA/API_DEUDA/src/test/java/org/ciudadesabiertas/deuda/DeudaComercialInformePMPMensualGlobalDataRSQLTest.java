...
public class DeudaComercialInformePMPMensualGlobalDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(DeudaComercialInformePMPMensualGlobalDataRSQLTest.class);
...
private String listURL = DeudaComercialInformePMPMensualGlobalController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "id=='2020-06-zaragoza'", 1 });
  params.add(new Object[] { "periodoMedioPagoMensualGlobal=='27.04'", 1 });

...
public class DeudaFinancieraAmortizacionDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(DeudaFinancieraAmortizacionDataRSQLTest.class);
...
private String listURL = DeudaFinancieraAmortizacionController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "id=='ES1234567893-c1'", 1 });
  params.add(new Object[] { "date=='2019-12-14'", 1 });
  params.add(new Object[] { "importe==300000000.00", 1 });
  params.add(new Object[] { "instrumentoFinanciacion=='ES1234567893'", 3 });
  return params;
}

...
public class DeudaComercialInformePMPMensualDataTest {

private static final Logger log = LoggerFactory.getLogger(DeudaComercialInformePMPMensualDataTest.class);

...
import org.ciudadesabiertas.dataset.controller.DeudaFinancieraAnualController;
...
public class DeudaFinancieraAnualTest {
	
	private static final Logger log = LoggerFactory.getLogger(DeudaFinancieraAnualTest.class);
	
	@Autowired
	private WebApplicationContext wac;

    @Autowired
    private DatasetService<DeudaFinancieraAnual> service;
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<DeudaFinancieraAnual> list = service.basicQuery(DeudaConstants.KEY,DeudaFinancieraAnual.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("deudaFinancieraAnualController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaFinancieraAnualController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
    	...
    	String id ="2022-OK";
         ...
         this.mockMvc.perform(MockMvcRequestBuilders.post(DeudaFinancieraAnualController.ADD)
    ...
    public void test07_Update() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(DeudaFinancieraAnualController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(itemUPDATE))	
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaFinancieraAnualController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(DeudaFinancieraAnualController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test13_Delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete(DeudaFinancieraAnualController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(DeudaFinancieraAnualController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(DeudaFinancieraAnualController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(DeudaFinancieraAnualController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaFinancieraAnualController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }

    @Test    
    public void test18_Post_Transform() throws Exception {
    	String id ="2022-TRANSFORM";
     	String item = " {\n" + 
     			"      \"id\":\"" +id+"\",\n" +
     		    "      \"date\": \"2019-12-31T00:00:00\",\n" +
     			"      \"endeudamiento\": 2232568750\n" +
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(DeudaFinancieraAnualController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (DeudaFinancieraAnual.class).getDeclaredFields();
    ...
    public void test22_List_Sort_400() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaFinancieraAnualController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    ...
    public void test23_List_Distinct_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaFinancieraAnualController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(DeudaFinancieraAnualController.LIST, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }
    
    @Test
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,DeudaFinancieraAnualController.LIST);        
    ...
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	...
    	boolean checkAllFormats=TestUtils.checkFormatURIs(DeudaFinancieraAnualController.LIST+"/"+id, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

...
public class DeudaFinancieraCapitalVivoTestFK {
	...
	public void test07_Update() throws Exception {
		...
		if (activeFK == false) {
			...
			this.mockMvc
					.perform(MockMvcRequestBuilders.put(DeudaFinancieraCapitalVivoController.ADD + "/" + id)
	...
	public void test99_Delete() throws Exception {
		if (activeFK == false) {
			...
			this.mockMvc
					.perform(MockMvcRequestBuilders.delete(DeudaFinancieraCapitalVivoController.ADD + "/" + id)

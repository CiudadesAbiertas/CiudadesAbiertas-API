...
public class DeudaComercialInformePMPMensualGlobalDataTest {

private static final Logger log = LoggerFactory.getLogger(DeudaComercialInformePMPMensualGlobalDataTest.class);

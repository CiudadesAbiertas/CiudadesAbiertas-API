...
public class DeudaOrganizationTest {
	
	private static final Logger log = LoggerFactory.getLogger(DeudaOrganizationTest.class);
	
	@Autowired
	private WebApplicationContext wac;

    @Autowired
    private DatasetService<DeudaOrganization> service;
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<DeudaOrganization> list = service.basicQuery(DeudaConstants.KEY,DeudaOrganization.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("deudaOrganizationController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaOrganizationController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
    	...
    	String id ="300-TEST-000000524";
         ...
         this.mockMvc.perform(MockMvcRequestBuilders.post(DeudaOrganizationController.ADD)
    ...
    public void test07_Update() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(DeudaOrganizationController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(itemUPDATE))	
    ...
    public void test10_Record() throws Exception {
    	String id ="02-50-297-AO-005";

    	id=Util.encodeURL(id);
    	    	
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaOrganizationController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(DeudaOrganizationController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test13_Delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete(DeudaOrganizationController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(DeudaOrganizationController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(DeudaOrganizationController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(DeudaOrganizationController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaOrganizationController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(DeudaOrganizationController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (DeudaOrganization.class).getDeclaredFields();
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaOrganizationController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaOrganizationController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    ...
    public void test23_List_Distinct_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(DeudaOrganizationController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(DeudaOrganizationController.LIST, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }
    
    @Test
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,DeudaOrganizationController.LIST);        
    ...
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	...
    	boolean checkAllFormats=TestUtils.checkFormatURIs(DeudaOrganizationController.LIST+"/"+id, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

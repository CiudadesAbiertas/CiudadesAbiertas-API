...
public class DeudaFinancieraCapitalVivoDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(DeudaFinancieraCapitalVivoDataRSQLTest.class);
...
private String listURL = DeudaFinancieraCapitalVivoController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "id=='2020-06-30-ES1234567893'", 1 });
  params.add(new Object[] { "date=='2020-06-30'", 1 });
  params.add(new Object[] { "importe==24000000.00", 1 });
  params.add(new Object[] { "instrumentoFinanciacion=='ES1234567893'", 1 });

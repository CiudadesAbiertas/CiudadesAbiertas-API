...
public class DeudaFinancieraRelPrestamoEntidadDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(DeudaFinancieraRelPrestamoEntidadDataRSQLTest.class);

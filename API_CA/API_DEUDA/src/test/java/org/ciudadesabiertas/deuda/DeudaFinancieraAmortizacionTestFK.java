...
public class DeudaFinancieraAmortizacionTestFK {
	...
	public void test07_Update() throws Exception {
		...
		if (activeFK == false) {
			...
			this.mockMvc
					.perform(MockMvcRequestBuilders.put(DeudaFinancieraAmortizacionController.ADD + "/" + id)
	...
	public void test99_Delete() throws Exception {
		if (activeFK == false) {
			...
			this.mockMvc
					.perform(MockMvcRequestBuilders.delete(DeudaFinancieraAmortizacionController.ADD + "/" + id)

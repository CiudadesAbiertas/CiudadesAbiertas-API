...
@Entity
@ApiModel
@Table(name = "deuda_c_publica_interval")
@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonPropertyOrder(alphabetic=false)
@JsonIgnoreProperties({Constants.IKEY})
@JacksonXmlRootElement(localName = Constants.RECORD)
@Rdf(contexto = Context.TIME, propiedad = "ProperInterval")
@PathId(value="/deuda-publica-comercial/proper-interval")
public class DeudaComercialProperInterval  implements java.io.Serializable, RDFModel {
	
	@JsonIgnore
	private static final long serialVersionUID = -1504641833269124191L;	
	...
	public DeudaComercialProperInterval()
	{
	}

	public DeudaComercialProperInterval(DeudaComercialProperInterval copia) {
		super();
	...
	public DeudaComercialProperInterval(DeudaComercialProperInterval copia, List<String> attributesToSet)
	{
	...
	{
		return (T) cloneClass((DeudaComercialProperInterval) copia, listado);
	}
	
	public DeudaComercialProperInterval cloneClass(DeudaComercialProperInterval copia, List<String> attributesToSet) {

		DeudaComercialProperInterval obj = new DeudaComercialProperInterval(copia,attributesToSet);		

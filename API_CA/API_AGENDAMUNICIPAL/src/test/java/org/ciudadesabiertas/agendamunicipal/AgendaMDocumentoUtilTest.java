...
public class AgendaMDocumentoUtilTest
{
	...
	public void constructorCopia() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		...
		AgendaMDocumento mappedObj = mapper.readValue(testJSON, AgendaMDocumento.class);
		AgendaMDocumento agenda = new AgendaMDocumento(mappedObj);
	...
	public void constructorCampos() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		...
		AgendaMDocumento agenda = new AgendaMDocumento(mappedObj, listaCampos);
		boolean allFields = TestUtils.checkAllAttributes(agenda, fieldsToIngore);
		assertTrue(allFields);
	}

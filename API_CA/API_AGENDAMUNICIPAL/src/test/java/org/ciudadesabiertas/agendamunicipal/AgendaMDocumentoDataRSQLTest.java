...
public class AgendaMDocumentoDataRSQLTest
{
	...
	public void test_Busqueda_name() throws Exception
	{
		...
		String value = "name=='Documento de cuentas Club Deportivo*'";
	...
	public void test_Busqueda_url() throws Exception
	{
		...
		String value = "url=='https://datos.madrid.es/FwFront/portal_egob/new/img/portal_logo_h.png'";

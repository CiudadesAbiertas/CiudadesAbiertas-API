...
@RestController
@Api(value="Agenda Municipal - Documentación",description = "Conjunto de operaciones relacionadas con el conjunto de datos Agenda Municipal - Documentación", tags= {"Agenda Municipal - Documentación"})
public class AgendaMDocumentoController extends GenericController implements CiudadesAbiertasController 
{
	public static final String LIST = "/agendaMunicipal/documento";

...
public class ConvenioSuscEntidadUtilTest
{

	private static final String[] fieldsToIngore = { "ikey" };
	
	private static final String testJSON = " {\r\n" 
			+ "   \"id\": \"TEST_CONVSUSENT001\",\r\n" 
	...
	public void constructorCopia() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		...
		ConvenioSuscEntidad mappedObj = mapper.readValue(testJSON, ConvenioSuscEntidad.class);
		ConvenioSuscEntidad agenda = new ConvenioSuscEntidad(mappedObj);
	...
	public void constructorCampos() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		...
		ConvenioSuscEntidad agenda = new ConvenioSuscEntidad(mappedObj, listaCampos);
		boolean allFields = TestUtils.checkAllAttributes(agenda, fieldsToIngore);
		assertTrue(allFields);
	}

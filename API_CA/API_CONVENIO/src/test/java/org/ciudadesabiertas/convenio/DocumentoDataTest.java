...
public class DocumentoDataTest
{
	...
	private String listURL=ConvenioDocumentoController.LIST;
	...
	public void test_Busqueda_name() throws Exception
	{
		...
		String value = "documento del convenio 2";
	...
	public void test_Busqueda_URL() throws Exception
	{
		...
		String value = "https://sede.madrid.es/UnidadesDescentralizadas/DistritoVillaverde/Actividades/FIESTAS19/ficheros/2.png";
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		long total = TestUtils.extractTotalDistinct(ConvenioDocumentoController.SEARCH_DISTINCT, paramField, value, mockMvc);

...
public class ConvRelFirmanteEntidadTestFK {
    ...
    public void test_01_add() throws Exception {
    	...
    	{    	
    		String id ="TEST01_FIRMANTEENTIDAD01";
        	String item = "{"   			
        			+ "	  \"id\": \""+id+"\",\r\n"         			
        			+ "   \"firmanteRole\": \"Carlos M. C. G.\",\r\n"			
        			+ "   \"organizationId\": \"ORGLOC0010\",\r\n"
        			+ "   \"entidadId\": \"CONVSUSENT001\" " 			
        			+ "    }";      	    	    	
	     	item = new String (item.getBytes(),"UTF-8");
	     	 
	         this.mockMvc.perform(MockMvcRequestBuilders.post(ConvRelFirmanteEntidadController.ADD)
    ...
    public void test_02_add() throws Exception {
    	...
    	{    	
        	...
        	String item = "{"   			
        			+ "	  \"id\": \""+id+"\",\r\n"         			
        			+ "   \"firmanteRole\": \"Carlos M. C. G.\",\r\n"			
        			+ "   \"organizationId\": \"ORGMALLOC0010\",\r\n"
        			+ "   \"entidadId\": \"CONVMALSUSENT001\" "  			
        			+ "    }";      	    	    	
	     	item = new String (item.getBytes(),"UTF-8");
    ...
    @Test
    public void test_03_update_KO() throws Exception {
    	...
    	{    	
    		...
    		String item = "{"   			
	     	...
	     	item = new String (item.getBytes(),"UTF-8");
	     	 ...
	     	 this.mockMvc.perform(MockMvcRequestBuilders.put(ConvRelFirmanteEntidadController.ADD+"/"+id)
	         		.contentType(MediaType.APPLICATION_JSON)
	     	        .content(item)).andExpect(MockMvcResultMatchers.status().isConflict());
    	}
	...
	public void test_99_Delete() throws Exception {
		if (activeFK == false) {
			...
			this.mockMvc
					.perform(MockMvcRequestBuilders.delete(ConvRelFirmanteEntidadController.ADD + "/" + id)
							.contentType(MediaType.APPLICATION_JSON))

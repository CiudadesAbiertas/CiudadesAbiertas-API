...
public class ConvenioTest {
	...
	private static final Logger log = LoggerFactory.getLogger(ConvenioTest.class);
	
	@Autowired
	private WebApplicationContext wac;

    @Autowired
    private DatasetService<Convenio> service;
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<Convenio> list = service.basicQuery(ConvenioConstants.KEY,Convenio.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("convenioController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(ConvenioController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test07_Update() throws Exception {
    	String id ="300-TEST-000000524";
     	String item = " {\n" + 
				   ...
				   "   \"fechaFinalizacion\": \"2021-02-01T00:00:00\",\n" +
				   "   \"fechaSuscripcion\": \"2020-02-03T00:00:00\",\n" +
				   "   \"fechaResolucionFin\": \"2020-05-01T00:00:00\",\n" +
				   "   \"fechaIncorporacion\": \"2020-04-01T00:00:00\",\n" +
				   "   \"obligacionEconomicaAyto\": 1298000.8,\n" +
				   "   \"tipoConvenio\": \"tipo-convenio-x\",\n" +
				   "   \"modalidad\": \"modalidad-convenio-x\",\n" +
				   "   \"materia\": \"tipo-materia-x\",\n" +
				   "   \"fechaAdjudicacionSub\": \"2020-04-11T00:00:00\",\n" +
				   "   \"importeSubv\": 329900.8,\n" +
				   "   \"adjudicatarioTitleSub\": \"Pedro Ruiz Gomezx\",\n" +
				   "   \"subvencionId\": \"SUBV001\",\n" +
				   "   \"organizationId\": \"ORG0001\",\n" +
				   "   \"orgIdObligadoPrestacion\": \"ORG0002\",\n" +
				   "   \"gestionadoPorOrganization\": true,\n" +
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(ConvenioController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(itemUPDATE))	
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(ConvenioController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(ConvenioController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test13_Delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete(ConvenioController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(ConvenioController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(ConvenioController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(ConvenioController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(ConvenioController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(ConvenioController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (Convenio.class).getDeclaredFields();
    	
    	boolean checkFields=true;
    	
    	String [][] exceptionFields = {
    				{"subvencionId",	"organizationId",	"orgIdObligadoPrestacion",			"distritoId",		"prorrogaId", "esVariacionId"},
    				{"instrumenta",		"gestionadoPor",	"obligadoPrestacionesAyuntamiento",	"gestionadoPor",	"esProrrogaDe","esVariacionDe"}};
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(ConvenioController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(ConvenioController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    ...
    public void test23_List_Distinct_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(ConvenioController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(ConvenioController.LIST, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }
    
    @Test
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,ConvenioController.LIST);        
    ...
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	...
    	boolean checkAllFormats=TestUtils.checkFormatURIs(ConvenioController.LIST+"/"+id, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

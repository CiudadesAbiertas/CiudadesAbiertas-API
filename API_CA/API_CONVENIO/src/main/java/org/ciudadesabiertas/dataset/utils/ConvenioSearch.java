 ...
 *
 */
public class ConvenioSearch extends Convenio implements  Serializable, DatasetSearch<Convenio> {

	@JsonIgnore
	private static final long serialVersionUID = -3073368021929583183L;	

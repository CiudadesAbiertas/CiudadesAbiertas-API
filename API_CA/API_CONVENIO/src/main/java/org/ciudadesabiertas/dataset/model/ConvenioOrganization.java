...
@Entity
@ApiModel
@Table(name = "convenio_organization")
@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonPropertyOrder(alphabetic = false)
@JsonIgnoreProperties({ Constants.IKEY })
@JacksonXmlRootElement(localName = Constants.RECORD)
@Rdf(contexto = Context.ORG, propiedad = "Organization")
@PathId(value = "/convenio/organization")
public class ConvenioOrganization implements java.io.Serializable, RDFModel, ICallejero {
	...
	public ConvenioOrganization() {
		
	}

	public ConvenioOrganization(ConvenioOrganization copia)
	{		
	...
	public ConvenioOrganization(ConvenioOrganization copia, List<String> attributesToSet)
	{
	...
	{
		return (T) cloneClass((ConvenioOrganization) copia, listado);
	}
	
	public ConvenioOrganization cloneClass(ConvenioOrganization copia, List<String> attributesToSet) {

		ConvenioOrganization obj = new ConvenioOrganization(copia,attributesToSet);		
	...
	public String toString() {
		return "ConvenioOrganization [ikey=" + ikey + ", id=" + id + ", title=" + title + ", url=" + url

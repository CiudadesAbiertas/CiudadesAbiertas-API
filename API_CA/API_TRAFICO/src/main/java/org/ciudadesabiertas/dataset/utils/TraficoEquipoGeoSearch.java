 ...
 */
public class TraficoEquipoGeoSearch extends TraficoEquipo implements  Serializable, DatasetSearch<TraficoEquipo> {
	...
	@ApiModelProperty(required=true, value = "Coordenada X del equipo. Ejemplo: 440654.00047")
	private BigDecimal xETRS89;	
	
	@ApiModelProperty(required=true, value = "Coordenada Y del equipo. Ejemplo: 4475352.11778")

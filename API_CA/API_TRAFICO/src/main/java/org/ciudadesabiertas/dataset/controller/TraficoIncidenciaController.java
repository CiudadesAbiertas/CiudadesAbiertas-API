...
public class TraficoIncidenciaController extends GenericController implements CiudadesAbiertasController 
{
			...
			@RequestHeader HttpHeaders headersRequest)
	{
		...
		return list(request, search, fields, rsqlQ, page, pageSize, sort, NO_HAY_SRID, LIST,new TraficoIncidencia(), new TraficoIncidenciaResult(), 
	...
	public @ResponseBody ResponseEntity<?> record(HttpServletRequest request, @PathVariable String id)
	{
		...
		return record(request, id, new TraficoIncidencia(),new TraficoIncidenciaResult(), NO_HAY_SRID, nameController, RECORD, service,getKey());
	...
	public @ResponseBody ResponseEntity<?> transform(
			@ApiParam(required = true, name = Constants.OBJETO, value = SwaggerConstants.PARAM_PLANTILLA_TEXT) @RequestBody TraficoIncidencia obj) {

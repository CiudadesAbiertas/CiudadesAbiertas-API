 ...
 */
public class TraficoIncidenciaSearch extends TraficoIncidencia implements  Serializable, DatasetSearch<TraficoIncidencia> {
	...
	@ApiModelProperty(value = "Coordenada X de una incidencia. Ejemplo: 440396.51166")
	private BigDecimal xETRS89;	
	
	@ApiModelProperty(value = "Coordenada Y de una incidencia. Ejemplo: 4474341.38044")

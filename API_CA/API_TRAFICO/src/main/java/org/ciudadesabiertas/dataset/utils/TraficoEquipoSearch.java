 ...
 */
public class TraficoEquipoSearch extends TraficoEquipo implements  Serializable, DatasetSearch<TraficoEquipo> {
	...
	@ApiModelProperty(value = "Coordenada X del equipo. Ejemplo: 440654.00047")
    private BigDecimal xETRS89;	
	
	@ApiModelProperty(value = "Coordenada Y del equipo. Ejemplo: 4475352.11778")

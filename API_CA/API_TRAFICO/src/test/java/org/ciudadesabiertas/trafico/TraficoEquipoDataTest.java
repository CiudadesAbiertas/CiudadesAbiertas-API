...
public class TraficoEquipoDataTest
{
	...
	private String listURL=TraficoEquipoController.LIST;
	...
	public void test_Busqueda_description() throws Exception
	{
		...
		String value = "C. GRAN VIA;C. Alcalá";
	...
	public void test_Busqueda_id_getX_getY() throws Exception
	{
		...
		String [] value = {"EPSG:25830","TRAFEQUI01"};
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		long total = TestUtils.extractTotalDistinct(TraficoEquipoController.SEARCH_DISTINCT, paramField, value, mockMvc);

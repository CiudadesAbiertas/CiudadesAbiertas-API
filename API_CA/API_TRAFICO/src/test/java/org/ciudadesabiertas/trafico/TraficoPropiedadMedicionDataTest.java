...
public class TraficoPropiedadMedicionDataTest
{
	...
	private String listURL=TraficoPropiedadMedicionController.LIST;
	...
	public void test_Busqueda_description() throws Exception
	{
		...
		String value = "Propiedad de medición de carga";
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		long total = TestUtils.extractTotalDistinct(TraficoPropiedadMedicionController.SEARCH_DISTINCT, paramField, value, mockMvc);

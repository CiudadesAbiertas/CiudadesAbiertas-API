...
public class TraficoDispositivoMedicionTest {
	
	private static final Logger log = LoggerFactory.getLogger(TraficoDispositivoMedicionTest.class);
	
	@Autowired
	private WebApplicationContext wac;

	@Autowired
	private DatasetService<TraficoDispositivoMedicion> dsService;	
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<TraficoDispositivoMedicion> items = dsService.basicQuery(TraficoConstants.KEY,TraficoDispositivoMedicion.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("traficoDispositivoMedicionController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(TraficoDispositivoMedicionController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(TraficoDispositivoMedicionController.ADD)
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(TraficoDispositivoMedicionController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(TraficoDispositivoMedicionController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test12_Record_NO_OK_404() throws Exception {
    	String id ="TEST01_NOOK_TRAFDISMED0001";
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(TraficoDispositivoMedicionController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(TraficoDispositivoMedicionController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(TraficoDispositivoMedicionController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(TraficoDispositivoMedicionController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }

    @Test    
    public void test18_Post_Transform() throws Exception {
    	String id ="TEST01_TRASFORM_TRAFDISMED0001";
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(TraficoDispositivoMedicionController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
...
//    			+ "	  \"id\": \""+id+"\",\r\n" 
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (TraficoDispositivoMedicion.class).getDeclaredFields();
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(TraficoDispositivoMedicionController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(TraficoDispositivoMedicionController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    
    @Test    
    public void test23_List_Distinct_200() throws Exception {
    	String sort="?field=id";
        this.mockMvc.perform(MockMvcRequestBuilders.get(TraficoDispositivoMedicionController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(TraficoDispositivoMedicionController.LIST, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }
    
    @Test
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,TraficoDispositivoMedicionController.LIST);        
        this.mockMvc.perform(MockMvcRequestBuilders.get(theURI)).andExpect(MockMvcResultMatchers.status().is(200));    	    	
    }

    @Test
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(TraficoDispositivoMedicionController.LIST+"/"+"TRAFDISMED01", mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

...
public class TraficoObservacionDataTest
{
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		long total = TestUtils.extractTotalDistinct(TraficoObservacionController.SEARCH_DISTINCT, paramField, value, mockMvc);

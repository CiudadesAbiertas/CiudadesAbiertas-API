 ...
 *
 */
public class ContAcusticaEstacionMedidaGeoSearch extends ContAcusticaEstacionMedida implements  Serializable, DatasetSearch<ContAcusticaEstacionMedida> {

	@JsonIgnore
	private static final long serialVersionUID = -3773331021929583183L;	

...
public class ContAcusticaObservacionTest {
	
	private static final Logger log = LoggerFactory.getLogger(ContAcusticaObservacionTest.class);
	
	@Autowired
	private WebApplicationContext wac;

	@Autowired
	private DatasetService<ContAcusticaObservacion> dsService;	
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<ContAcusticaObservacion> items = dsService.basicQuery(ContaminacionAcusticaConstants.KEY,ContAcusticaObservacion.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("contAcusticaObservacionController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(ContAcusticaObservacionController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(ContAcusticaObservacionController.ADD)
    ...
    public void test07_Update() throws Exception {
    	String id ="TEST01_CONTACUSTOBVD001";
    	String jsonItem =  " {\r\n" + 
    			"    \"id\": \""+id+"\",\r\n" + 
    			"    \"observedProperty\" : \"nivelRuido\",\r\n" +
    			"    \"madeBySensor\" : \"CONTACUSTESTMED001\",\r\n" +
    			"    \"resultTime\" : \"2020-04-15T08:00:00\",\r\n" +
    			"    \"hasSimpleResult\" : 136.12,\r\n" +
    			"    \"validada\" : false,\r\n" +
    			"    \"tipoMedicion\" : \"LAS50\",\r\n" +
    			"    \"tipoEmisorPredominante\" : \"ferrocarriles\",\r\n" +
    			"    \"tipoIntervaloReferencia\" : \"D\"\r\n" +
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(ContAcusticaObservacionController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(itemUpdate))	
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(ContAcusticaObservacionController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(ContAcusticaObservacionController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test13_Delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete(ContAcusticaObservacionController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(ContAcusticaObservacionController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(ContAcusticaObservacionController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(ContAcusticaObservacionController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(ContAcusticaObservacionController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(ContAcusticaObservacionController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
...
//    			"      \"id\": \""+id+"\",\r\n" +     			
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (ContAcusticaObservacion.class).getDeclaredFields();
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(ContAcusticaObservacionController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(ContAcusticaObservacionController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    
    @Test    
    public void test23_List_Distinct_200() throws Exception {
    	String sort="?field=id";
        this.mockMvc.perform(MockMvcRequestBuilders.get(ContAcusticaObservacionController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(ContAcusticaObservacionController.LIST, mockMvc);
    ...
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,ContAcusticaObservacionController.LIST);        

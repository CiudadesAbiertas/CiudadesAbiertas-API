...
public class ContAcusticaPropiedadDataRSQLTest
{
	...
	private String listURL=ContAcusticaPropiedadController.LIST;
	...
	public void test_Busqueda_observedProperty() throws Exception
	{
		...
		String value = "description=='nivelRuido'";

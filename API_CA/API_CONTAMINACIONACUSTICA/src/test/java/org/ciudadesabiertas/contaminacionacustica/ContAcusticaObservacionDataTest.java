...
public class ContAcusticaObservacionDataTest
{
	...
	{
		String paramField="observedProperty";
	...
	public void test_Busqueda_resultTime() throws Exception
	{
		...
		String value = "2020-04-15 08:00:00"; 
	...
	{
		String paramField="tipoMedicion";
	...
	{
		String paramField="tipoEmisorPredominante";

		String value = "ferrocarriles";
	...
	{
		String paramField="tipoIntervaloReferencia";
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		long total = TestUtils.extractTotalDistinct(ContAcusticaObservacionController.SEARCH_DISTINCT, paramField, value, mockMvc);

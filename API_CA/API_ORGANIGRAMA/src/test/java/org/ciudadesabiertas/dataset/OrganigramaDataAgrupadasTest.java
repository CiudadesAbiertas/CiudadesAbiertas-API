...
public class OrganigramaDataAgrupadasTest {
	@Autowired
	private WebApplicationContext wac;

	JSONParser parser = new JSONParser();

	private String listURL = OrganigramaController.SEARCHGROUP;
	...
	public void test_Busqueda_Agrupada_01() throws Exception {
		...
		String params = "fields=count(tipoEntidadTitle),tipoEntidadTitle&group=tipoEntidadTitle";

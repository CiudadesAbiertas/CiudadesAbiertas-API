...
@RestController
@Api(value="PresupuestoGasto",description = "Conjunto de operaciones sobre Presupuesto Gasto del conjunto de datos Presupuesto", tags= {"Presupuesto - Presupuesto Gasto"})

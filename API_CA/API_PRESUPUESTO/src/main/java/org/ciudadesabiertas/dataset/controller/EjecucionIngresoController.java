...
@RestController
@Api(value="EjecucionIngreso",description = "Conjunto de operaciones sobre Ejecucion Ingreso del conjunto de datos Presupuesto", tags= {"Presupuesto - Ejecucion Ingreso"})

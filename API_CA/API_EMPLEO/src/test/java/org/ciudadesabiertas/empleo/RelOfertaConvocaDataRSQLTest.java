...
public class RelOfertaConvocaDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(RelOfertaConvocaDataRSQLTest.class);
...
private String listURL = RelOfertaConvocaController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "id=='relOferta01'", 1 });
  params.add(new Object[] { "convocatoriaId=='convocatoria001'", 1 });
  params.add(new Object[] { "ofertaId=='oferta001'", 1 });

...
public class BoletinOficialDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(BoletinOficialDataRSQLTest.class);
...
private String listURL = BoletinOficialController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "id=='boletin001'", 1 });
  params.add(new Object[] { "description=='Boletin inicial'", 1 });
  params.add(new Object[] { "id_local=='https://www.boe.es/eli/es-md/a/2020/11/02'", 1 });
  params.add(new Object[] { "title=='Boletín Oficial*'", 2 });
  params.add(new Object[] { "datePublished=='2020-11-23T12:30:38'", 1 });

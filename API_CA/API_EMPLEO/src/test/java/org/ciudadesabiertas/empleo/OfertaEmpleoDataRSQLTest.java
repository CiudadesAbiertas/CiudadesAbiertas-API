...
public class OfertaEmpleoDataRSQLTest {

	private static final Logger log = LoggerFactory.getLogger(OfertaEmpleoDataRSQLTest.class);
...
// Posibles valores que tomaran los parámetros anteriores
	...
	public void test_evaluador_RSQL() throws Exception {
		...
		try {
			...
			throw new AssertionError("Incorrect value on Expresion " + expression + ": " + records.size(),
					new Throwable("Expected: " + expected));
		}
	}
}

...
public class PlazaPorTurnoDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(PlazaPorTurnoDataRSQLTest.class);
...
private String listURL = PlazaPorTurnoController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "id=='plazas01'", 1 });
  params.add(new Object[] { "plazasPorTurno=='5'", 1 });
  params.add(new Object[] { "turnoPlaza=='libre'", 2 });

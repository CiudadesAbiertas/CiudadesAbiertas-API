...
public class RelBoletinConvocaTestFK {
    ...
    public void test_01_add() throws Exception {
    	...
    	{    	
    	  String jsonItem =  "  {\n"
    		+ "      \"id\": \"rel03\",\r\n"
    		+ "      \"convocatoriaId\": \"convocatoria00MAL\",\r\n"
    		+ "      \"boletinId\": \"boletin000MAL\"\r\n"
      		+ "    }";     	    	    	
    	...
    	{    	
    	  String jsonItem =  "  {\n"
      	  ...
      	  jsonItem = new String (jsonItem.getBytes(),"UTF-8");	    	
	     	 ...
	     	 this.mockMvc.perform(MockMvcRequestBuilders.put(RelBoletinConvocaController.ADD+"/"+"plazas01")
	         		.contentType(MediaType.APPLICATION_JSON)
	     	        .content(jsonItem)).andExpect(MockMvcResultMatchers.status().isConflict());
    	}

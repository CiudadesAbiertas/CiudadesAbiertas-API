...
public class RelOfertaConvocaTestFK {
    ...
    public void test_01_add() throws Exception {
    	...
    	{  
    		String jsonItem = "{\r\n"
        		+ "      \"id\": \"relOferta99\",\r\n"
        		+ "      \"convocatoriaId\": \"convocatoria023\",\r\n"
        		+ "      \"ofertaId\": \"oferta023\"\r\n"
        		+ "    }";
    	...
    	{    	
    	  String jsonItem = "{\r\n"
      	  ...
      	  jsonItem = new String (jsonItem.getBytes(),"UTF-8");	    	
	     	 ...
	     	 this.mockMvc.perform(MockMvcRequestBuilders.put(RelOfertaConvocaController.ADD+"/"+"relOferta01")
	         		.contentType(MediaType.APPLICATION_JSON)
	     	        .content(jsonItem)).andExpect(MockMvcResultMatchers.status().isConflict());
    	}

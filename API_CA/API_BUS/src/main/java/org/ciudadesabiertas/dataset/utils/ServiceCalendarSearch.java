 ...
 */
public class ServiceCalendarSearch extends ServiceCalendar implements  Serializable, DatasetSearch<ServiceCalendar> {

	@JsonIgnore
	private static final long serialVersionUID = -1086906960223335190L;

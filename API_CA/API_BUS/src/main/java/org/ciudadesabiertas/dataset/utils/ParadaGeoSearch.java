 ...
 *
 */
public class ParadaGeoSearch extends Parada implements  Serializable, DatasetSearch<Parada> {

	@JsonIgnore
	private static final long serialVersionUID = -4703129921624303113L;	
	...
	@ApiModelProperty(required=true, value = "Coordenada X de la parada. Ejemplo: 440242.56")
    private BigDecimal xETRS89;	
	
	@ApiModelProperty(required=true, value = "Coordenada Y de la parada. Ejemplo: 4476174.2")

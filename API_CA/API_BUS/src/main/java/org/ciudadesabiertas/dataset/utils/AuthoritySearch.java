 ...
 */
public class AuthoritySearch extends Authority implements  Serializable, DatasetSearch<Authority> {

	@JsonIgnore
	private static final long serialVersionUID = -1286906960223334590L;

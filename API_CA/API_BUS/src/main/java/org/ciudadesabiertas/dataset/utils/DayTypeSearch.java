 ...
 */
public class DayTypeSearch extends DayType implements  Serializable, DatasetSearch<DayType> {

	@JsonIgnore
	private static final long serialVersionUID = -1080906960221331190L;

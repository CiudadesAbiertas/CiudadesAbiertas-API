 ...
 */
public class RealTimePassingTimeSearch extends RealTimePassingTime implements  Serializable, DatasetSearch<RealTimePassingTime> {

	@JsonIgnore
	private static final long serialVersionUID = -1286906960223334512L;

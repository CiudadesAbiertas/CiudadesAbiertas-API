...
public class HeadwayJourneyGroupDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(HeadwayJourneyGroupDataRSQLTest.class);
...
private String listURL = HeadwayJourneyGroupController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "id=='6a1-laborable'", 1 });
  params.add(new Object[] { "firstDepartureTime=='06:15:00'", 3 });
  params.add(new Object[] { "lastDepartureTime=='23:30:00'", 3 });
  params.add(new Object[] { "determinedBy=='6-laborable'", 1 });

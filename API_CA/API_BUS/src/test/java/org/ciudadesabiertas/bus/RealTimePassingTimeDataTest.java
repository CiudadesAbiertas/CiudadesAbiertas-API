...
public class RealTimePassingTimeDataTest {

private static final Logger log = LoggerFactory.getLogger(RealTimePassingTimeDataTest.class);
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "resultTime","2020-05-13 12:45:05", 1 });

...
public class LineaTest {
	...
	private static final Logger log = LoggerFactory.getLogger(LineaTest.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("lineaController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(LineaController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
    	String jsonItem =  "{\n" + 
    		...
    		"      \"title\": \"Línea 777\",\n" + 
    		"      \"url\": \"https://www.transportesPrueba.es/777\",\n" + 
    		"      \"shortName\": \"777\",\n" + 
    		"      \"distancia\": 58,\n" + 
    		"      \"colour\": \"Azul\",\n" + 
    		"      \"textColour\": \"Negro\",\n" + 
    ...
    public void test07_Update() throws Exception {
    	...
    	String jsonItem= "{\n" + 
    		"      \"id\": \""+id+"\",\n" + 
    		"      \"description\": \"La línea 777 garantiza varios días de suerte después de recorrerla en parte.\",\n" + 
    		"      \"title\": \"Línea 777\",\n" + 
    		"      \"url\": \"https://www.transportesPrueba.es/777\",\n" + 
    		"      \"shortName\": \"777\",\n" + 
    		"      \"distancia\": 58,\n" + 
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(LineaController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(itemUpdate))	
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(LineaController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(LineaController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test13_Delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete(LineaController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(LineaController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(LineaController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(LineaController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(LineaController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(LineaController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(LineaController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(LineaController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    ...
    public void test23_List_Distinct_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(LineaController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(LineaController.LIST, mockMvc);
    ...
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,LineaController.LIST);        
        this.mockMvc.perform(MockMvcRequestBuilders.get(theURI)).andExpect(MockMvcResultMatchers.status().is(200));    	    	
    }
    
    @Test
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(LineaController.LIST+"/"+"6", mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

...
public class DayTypeDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(DayTypeDataRSQLTest.class);
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "earliestTime>'05:29:00'", 2 });
  params.add(new Object[] { "earliestTime>='05:29:00' and earliestTime<='05:31:00'", 1 });
  return params;
}

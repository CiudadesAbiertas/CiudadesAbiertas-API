...
public class AuthorityTest {
	...
	@Autowired
	private DatasetService<Authority> dsService;	
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<Authority> items = dsService.basicQuery(BusConstants.KEY,Authority.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("authorityController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(AuthorityController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
    	String jsonItem =  " {\r\n" + 
			"      \"id\": \"AuthorityTest\",\r\n" + 
			"      \"legalName\": \"Consorcio de transportes 23\",\r\n" + 
			"      \"alternateName\": \"CT23\",\n" + 
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(AuthorityController.ADD)
    ...
    public void test07_Update() throws Exception {
    	...
    	String jsonItem= " {\r\n" + 
			"      \"id\": \""+id+"\",\r\n" + 
			"      \"legalName\": \"Consorcio de transportes 24\",\r\n" + 
			"      \"alternateName\": \"CT23\",\n" + 
			"      \"telephone\": \"+34 91 406 88 10\",\n" + 
			"      \"email\": \"info@crtm.es\",\n" + 
			"      \"url\": \"info@crtm.es\",\n" + 
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(AuthorityController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(itemUpdate))	
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(AuthorityController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(AuthorityController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test13_Delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete(AuthorityController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AuthorityController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AuthorityController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AuthorityController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(AuthorityController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(AuthorityController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (Authority.class).getDeclaredFields();
    ...
    public void test21_List_Sort_200() throws Exception {
    	String sort="?sort=-id,legalName";
        this.mockMvc.perform(MockMvcRequestBuilders.get(AuthorityController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(AuthorityController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    ...
    public void test23_List_Distinct_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(AuthorityController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(AuthorityController.LIST, mockMvc);
    ...
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,AuthorityController.LIST);        
        this.mockMvc.perform(MockMvcRequestBuilders.get(theURI)).andExpect(MockMvcResultMatchers.status().is(200));    	    	
    }
    
    @Test
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(AuthorityController.LIST+"/"+"crtm", mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

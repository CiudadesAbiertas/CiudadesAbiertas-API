...
public class VehicleJourneyTestFK {
    ...
    public void test01_Add() throws Exception {
    	...
    	if (activeFK == false) {
			...
			this.mockMvc.perform(
					MockMvcRequestBuilders.post(VehicleJourneyController.ADD)
    ...
    @Test    
    public void test02_Add_ERROR_FK3() throws Exception {
    	
    	if (activeFK == false) {
			assertFalse(activeFK);
		} else {
    	
			String id ="BUSTEST004";
	    	String item =  "{\r\n" + 
	    		"      \"id\": \""+id+"\",\r\n" + 
	    		"      \"journeyDuration\": \"P1D\",\r\n" + 
	    		"      \"departureTime\": \"09:00:00\",\r\n" + 
    ...
    @Test    
    public void test03_Update_ERROR_FK3() throws Exception {

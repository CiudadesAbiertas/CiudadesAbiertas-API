...
public class DayTypeAssignmentDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(DayTypeAssignmentDataRSQLTest.class);
...
private String listURL = DayTypeAssignmentController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "id=='2020-01-02-CAL01-laborable'", 1 });
  params.add(new Object[] { "date=='2020-01-02 00:00:00'", 1 });
  params.add(new Object[] { "isAvailable==true", 2 });
  params.add(new Object[] { "specifying=='laborable'", 2 });
  params.add(new Object[] { "forTheDefinitionOf=='2020'", 2 });

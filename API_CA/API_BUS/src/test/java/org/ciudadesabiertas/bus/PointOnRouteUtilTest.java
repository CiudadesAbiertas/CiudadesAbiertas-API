...
public class PointOnRouteUtilTest
{
	...
	public void constructorCopia() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		...
		PointOnRoute mappedObj = mapper.readValue(testJSON, PointOnRoute.class);
		PointOnRoute item = new PointOnRoute(mappedObj);	
	...
	public void constructorCampos() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		...
		PointOnRoute item = new PointOnRoute(mappedObj, listaCampos);
		boolean allFields = TestUtils.checkAllAttributes(item, fieldsToIngore);
		assertTrue(allFields);
	}

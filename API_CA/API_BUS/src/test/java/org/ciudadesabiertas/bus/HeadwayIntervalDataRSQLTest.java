...
public class HeadwayIntervalDataRSQLTest {

private static final Logger log = LoggerFactory.getLogger(HeadwayIntervalDataRSQLTest.class);
...
private String listURL = HeadwayIntervalController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "id=='6-laborable'", 1 });
  params.add(new Object[] { "minimumHeadwayInterval=='P7M'", 1 });
  params.add(new Object[] { "maximumHeadwayInterval=='P20M'", 1 });
  params.add(new Object[] { "scheduledHeadwayInterval=='Cada 7 - 20 min.'", 1 });

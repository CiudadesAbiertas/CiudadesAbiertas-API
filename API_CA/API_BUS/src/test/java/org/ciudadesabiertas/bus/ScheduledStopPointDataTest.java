...
public class ScheduledStopPointDataTest {

private static final Logger log = LoggerFactory.getLogger(ScheduledStopPointDataTest.class);
...
private String listURL = ScheduledStopPointController.LIST;
...
public static Collection<Object[]> data() {
  ...
  params.add(new Object[] { "alighting","1", 3 });
  params.add(new Object[] { "boarding","0", 3 });

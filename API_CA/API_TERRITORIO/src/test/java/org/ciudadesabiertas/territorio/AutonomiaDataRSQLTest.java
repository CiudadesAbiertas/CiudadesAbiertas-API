...
public class AutonomiaDataRSQLTest
{
	
	@Autowired
	private WebApplicationContext wac;

	private String listURL=AutonomiaController.LIST;
	...
	public void test_Busqueda_RSQL_title() throws Exception
	{
		...
		String value = "title=='Comunidad de Madrid'";
	...
	public void test_Busqueda_RSQL_identifier() throws Exception
	{
		...
		String value = "identifier==Comunidad-Madrid";

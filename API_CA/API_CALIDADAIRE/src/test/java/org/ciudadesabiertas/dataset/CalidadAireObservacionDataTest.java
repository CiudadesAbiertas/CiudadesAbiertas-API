...
public class CalidadAireObservacionDataTest
{
	...
	{
		String paramField="hasDataValue";
	...
	{
		String paramField="madeBySensor";
	...
	{
		String paramField="observedPropertyTitle";

		String value = "Dióxido de Azufre";
	...
	{
		String paramField="observedPropertyId";

		String value = "dioxidoDeAzufre";
	...
	{
		String paramField="quality";

		String value = "Microgramo por metro cúbico";
	...
	{
		String paramField="resultTime";

		String value = "2019-03-27T01:00:00";
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		String value = "observedPropertyId";

		long total = TestUtils.extractTotalDistinct(CalidadAireObservacionController.SEARCH_DISTINCT, paramField, value, mockMvc);

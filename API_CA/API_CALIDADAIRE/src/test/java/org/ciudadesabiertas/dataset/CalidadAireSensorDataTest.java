...
public class CalidadAireSensorDataTest
{

	@Autowired
	private WebApplicationContext wac;

	private String listURL= CalidadAireSensorController.LIST;
	...
	@Test
	public void test_Busqueda_isHostedBy() throws Exception
	{
		String paramField="isHostedBy";		
		String value = "STAT04";
		JSONArray records = TestUtils.extractRecords(listURL, paramField, value, mockMvc);
	...
	{
		String[] paramField= {"id","observesId"};
		String[] value = {"STAT04","dioxidoDeAzufre"};
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		String value = "observesTitle";

		long total = TestUtils.extractTotalDistinct(CalidadAireSensorController.SEARCH_DISTINCT, paramField, value, mockMvc);

...
@RestController
@Api(value="CalidadAireObservacion",description = "Conjunto de operaciones relacionadas sobre observaciones del conjunto de datos Calidad del Aire"+SwaggerConstants.VOCABULARIO_A_HREF+CalidadAireConstants.airQualityObservationVocabURL+SwaggerConstants.VOCABULARIO_A_HREF_END, tags= {"Calidad del Aire - Observación"})
public class CalidadAireObservacionController extends GenericController implements CiudadesAbiertasController
{	

	public static final String LIST = "/calidad-aire/observacion";
	
	public static final String SEARCH_DISTINCT = LIST+"/distinct";
	
	public static final String RECORD = "/calidad-aire/observacion/{id}";
	...
	public @ResponseBody ResponseEntity<?> update(
			@ApiParam(required = true, name = Constants.IDENTIFICADOR, value = SwaggerConstants.PARAM_ID_TEXT+SwaggerConstants.PARAM_ID_CALIDAD_AIRE_OBSERVACION) 
	...
	public @ResponseBody ResponseEntity<?> record(HttpServletRequest request, @PathVariable @ApiParam(required = true, value=SwaggerConstants.PARAM_ID+SwaggerConstants.PARAM_ID_CALIDAD_AIRE_OBSERVACION) String id)
	{
	...
	public @ResponseBody ResponseEntity<?> recordHead(HttpServletRequest request, @PathVariable @ApiParam(required = true, value=SwaggerConstants.PARAM_ID+SwaggerConstants.PARAM_ID_CALIDAD_AIRE_OBSERVACION) String id)
	{

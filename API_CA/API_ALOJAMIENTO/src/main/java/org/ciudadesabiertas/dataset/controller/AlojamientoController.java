...
public class AlojamientoController extends GenericController implements CiudadesAbiertasController
{
			...
			@RequestHeader HttpHeaders headersRequest)
	{
		...
		return geoList(request, search, fields, meters, page, pageSize, sort, LIST, new Alojamiento(), new AlojamientoResult(), availableFields, getKey(),dsService);
	}
			...
			@RequestHeader HttpHeaders headersRequest)
	{
		...
		return list(request, search, fields, rsqlQ, page, pageSize, sort, srId, LIST,new Alojamiento(), new AlojamientoResult(), 
	...
	public @ResponseBody ResponseEntity<?> record(HttpServletRequest request, @PathVariable String id, @RequestParam(value = Constants.SRID, defaultValue = "", required = false) @ApiParam(value=SwaggerConstants.PARAM_SRID, allowableValues=Constants.SUPPORTED_SRIDS)  String srId)
	{
		...
		return record(request, id, new Alojamiento(), srId, nameController, RECORD, dsService,getKey());

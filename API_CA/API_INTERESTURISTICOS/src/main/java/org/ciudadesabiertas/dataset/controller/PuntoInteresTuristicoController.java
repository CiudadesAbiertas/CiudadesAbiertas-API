...
@RestController
@Api(value="PuntoInteresTuristico",description = "Conjunto de operaciones relacionadas con el conjunto de datos PuntoInteresTuristico", tags= {"Punto de Interés Turístico"})
public class PuntoInteresTuristicoController extends GenericController implements CiudadesAbiertasController
{
	public static final String LIST = "/puntoInteresTuristico/puntoInteresTuristico";
	
	public static final String GEO_LIST = LIST+ "/geo";
	
	public static final String SEARCH_DISTINCT = LIST+"/distinct";
	
	public static final String RECORD = "/puntoInteresTuristico/puntoInteresTuristico/{id}";
	
	public static final String TRANSFORM = "/puntoInteresTuristico/puntoInteresTuristico/transform";
	
	
	public static final String ADD = "/puntoInteresTuristico/puntoInteresTuristico";
	public static final String UPDATE = "/puntoInteresTuristico/puntoInteresTuristico/{id}";
	public static final String DELETE = "/puntoInteresTuristico/puntoInteresTuristico/{id}";

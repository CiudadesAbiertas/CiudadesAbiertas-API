...
public class PuntoInteresTuristicoTest {
	
	private static final Logger log = LoggerFactory.getLogger(PuntoInteresTuristicoTest.class);
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<PuntoInteresTuristico> users = dService.basicQuery(PuntoInteresTuristicoConstants.KEY,PuntoInteresTuristico.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("puntoInteresTuristicoController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(PuntoInteresTuristicoController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
    	...
    	String agendaADD = "{"    			
    		    ...
    		    +"\"category\" : \""+PuntoInteresTuristicoConstants.CATEGORY+"\","
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(PuntoInteresTuristicoController.ADD)
    ...
    public void test07_Update() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(PuntoInteresTuristicoController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(PuntoInteresTuristicoController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(PuntoInteresTuristicoController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test13_Delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete(PuntoInteresTuristicoController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(PuntoInteresTuristicoController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(PuntoInteresTuristicoController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(PuntoInteresTuristicoController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(PuntoInteresTuristicoController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {    
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(PuntoInteresTuristicoController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(PuntoInteresTuristicoController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(PuntoInteresTuristicoController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    
    @Test
   	public void test23_Busqueda_geo() throws Exception
   	{	    	
   		String sort="?xETRS89=440291&yETRS89=4474254&meters=50";
        this.mockMvc.perform(MockMvcRequestBuilders.get(PuntoInteresTuristicoController.GEO_LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
   	}
    
    @Test
    public void test24_List_Distinct_200() throws Exception {
    	String sort="?field=id";
        this.mockMvc.perform(MockMvcRequestBuilders.get(PuntoInteresTuristicoController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    ...
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,PuntoInteresTuristicoController.LIST);        

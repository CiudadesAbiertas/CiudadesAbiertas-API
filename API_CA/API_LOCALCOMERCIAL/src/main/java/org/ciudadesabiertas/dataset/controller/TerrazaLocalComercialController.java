...
@RestController
@Api(value = "Terraza", description = "Conjunto de operaciones sobre terrazas del conjunto de datos Local Comercial", tags = {
...
public class TerrazaLocalComercialController extends GenericController implements CiudadesAbiertasController {
	...
	public static final String LIST = "/localComercial/terraza";
	
	public static final String SEARCH_DISTINCT = LIST+"/distinct";

	public static final String RECORD = "/localComercial/terraza/{id}";

	public static final String TRANSFORM = "/localComercial/terraza/transform";

	public static final String ADD = "/localComercial/terraza";
	public static final String UPDATE = "/localComercial/terraza/{id}";
	public static final String DELETE = "/localComercial/terraza/{id}";

...
public class TerrazaComercialDataTest
{
	...
	{
		String paramField= "numeroMesasAutorizadas";
	...
	{
		String paramField= "numeroSillasAutorizadas";
	...
	{
		String paramField= "periodoFuncionamiento";

		String  value = "Estacional";
	...
	@Test
	public void test_Busqueda_opening_hours() throws Exception	
	{
		String paramField= "openingHours";

		String  value = "Lunes a jueves: de 10:00:00 hasta 21:00:00. Viernes y sábados: de 10:00:00 hasta 21:00:00";
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		String value = "superficie";

		long total = TestUtils.extractTotalDistinct(TerrazaLocalComercialController.SEARCH_DISTINCT, paramField, value, mockMvc);

		assertTrue(total == 179);
	}

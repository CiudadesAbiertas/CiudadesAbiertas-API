...
public class AgrupacionComercialDataRSQLTest
{
	...
	{
		String value = "title=='MERCADO MUNICIPAL DE TETUAN'";		
		String paramField = "q";
		long total = TestUtils.extractTotal(listURL,paramField, value,mockMvc);
		assertTrue(total == 1);
	}
	...
	{
		String value = "tipoAgrupacionComercial=='Mercado Municipal'";		
		String paramField = "q";
		long total = TestUtils.extractTotal(listURL,paramField, value,mockMvc);
		assertTrue(total == 4);
	}

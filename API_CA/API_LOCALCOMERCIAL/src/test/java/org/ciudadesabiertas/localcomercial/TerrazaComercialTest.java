...
public class TerrazaComercialTest {
	
	private static final Logger log = LoggerFactory.getLogger(TerrazaComercialTest.class);
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<Terraza> items = service.basicQuery(LocalComercialConstants.KEY,Terraza.class);
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(TerrazaLocalComercialController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    
    @Test    
    public void test04_Add() throws Exception {
    	String id ="TEST_TERRAZA_0001";
    	String itemAdd = "{"    			
    			+"\"id\" : \""+id+"\","
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(TerrazaLocalComercialController.ADD)
    ...
    public void test07_Update() throws Exception {
    	...
    	String obj = "{"    			
    			+"\"id\" : \""+id+"\","
    		    +"\"numeroMesasAutorizadas\" : 15,"
    		    +"\"numeroSillasAutorizadas\" : 30,"
    		    +"\"periodoFuncionamiento\" : \"Anual\","
    		    +"\"superficie\" : 14.23,"
    		    +"\"openingHours\" : \"Lunes a jueves: de 10:00:00 hasta 01:00:00. Viernes y sábados: de 10:00:00 hasta 02:00:00\","
    		    +"\"description\" : \"Acera\""
    	...
    	String AgrupacionComercialUPDATE = new String (obj.getBytes(),"UTF-8");	
    	
    	 
        this.mockMvc.perform(MockMvcRequestBuilders.put(TerrazaLocalComercialController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(AgrupacionComercialUPDATE))	
    ...
    public void test09_Update_NO_OK_404() throws Exception {
    	String id ="TEST_TERRAZA_NO_0001";
    	String obj = "{"    			
    			+"\"id\" : \""+id+"\","
    		    +"\"numeroMesasAutorizadas\" : 15,"
    		    +"\"numeroSillasAutorizadas\" : 30,"
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(TerrazaLocalComercialController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(TerrazaLocalComercialController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test14_Delete_NO_OK_404() throws Exception {
    	String id ="TEST_TERRAZA_0001_NOOK";
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(TerrazaLocalComercialController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(TerrazaLocalComercialController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(TerrazaLocalComercialController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(TerrazaLocalComercialController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	String AgrupacionComercialTransform = new String (obj.getBytes(),"UTF-8");	
    	
    	 
    	this.mockMvc.perform(MockMvcRequestBuilders.post(TerrazaLocalComercialController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(AgrupacionComercialTransform))	
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (Terraza.class).getDeclaredFields();
    ...
    public void test22_List_Sort_200() throws Exception {
    	String sort="?sort=-id,superficie";
        this.mockMvc.perform(MockMvcRequestBuilders.get(TerrazaLocalComercialController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test23_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(TerrazaLocalComercialController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    
    @Test    
    public void test24_List_Distinct_200() throws Exception {
    	String sort="?field=id";
        this.mockMvc.perform(MockMvcRequestBuilders.get(TerrazaLocalComercialController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    ...
    public void test25_List_Formatos_200() throws Exception {    	
    	...
    	boolean checkAllFormats=TestUtils.checkFormatURIs(TerrazaLocalComercialController.LIST, mockMvc);

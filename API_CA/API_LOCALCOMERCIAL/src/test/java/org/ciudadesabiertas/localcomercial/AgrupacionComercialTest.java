...
public class AgrupacionComercialTest {
	
	private static final Logger log = LoggerFactory.getLogger(AgrupacionComercialTest.class);
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<AgrupacionComercial> items = service.basicQuery(LocalComercialConstants.KEY,AgrupacionComercial.class);
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgrupacionComercialController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
    	String itemAdd = "{"    			
    			+"\"id\" : \"TEST00213\","
    			+"\"title\" : \"CENTRO COMERCIAL TULULIANO\","
    			+"\"tipoAgrupacionComercial\" : \"Centro Comercial\""
        	  +"}";
    	
    	itemAdd = new String (itemAdd.getBytes(),"UTF-8");	
    	
    	 
        this.mockMvc.perform(MockMvcRequestBuilders.post(AgrupacionComercialController.ADD)
    ...
    public void test07_Update() throws Exception {
    	...
    	String obj = "{"    			
    			+"\"id\" : \""+id+"\","
    			+"\"title\" : \"CENTRO COMERCIAL TULULIANO 2\","
    			+"\"tipoAgrupacionComercial\" : \"Centro Comercial\""
        	  +"}";
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(AgrupacionComercialController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test08_Update_NO_OK_400() throws Exception {
    	String id ="TEST00213";
    	String AgrupacionComercialUPDATE = "{"      	
    			+"}";
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgrupacionComercialController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(AgrupacionComercialController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AgrupacionComercialController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AgrupacionComercialController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AgrupacionComercialController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgrupacionComercialController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(AgrupacionComercialController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (AgrupacionComercial.class).getDeclaredFields();
    ...
    public void test22_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgrupacionComercialController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test23_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgrupacionComercialController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    
    @Test    
    public void test24_List_Distinct_200() throws Exception {
    	String sort="?field=id";
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgrupacionComercialController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }

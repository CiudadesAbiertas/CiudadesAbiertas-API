...
@RestController
@Api(value="Aviso Queja Sugerencia",description = "Conjunto de operaciones relacionadas con el conjunto de datos Avisos Quejas y Sugerencias", tags= {"Aviso Queja Sugerencia"})
public class AvisoQuejaSugController extends GenericController implements CiudadesAbiertasController
{
	

	public static final String LIST = "/avisoQuejaSugerencia/avisoQuejaSugerencia";
	
	public static final String GEO_LIST = LIST+ "/geo";
	
	public static final String SEARCH_DISTINCT = LIST+"/distinct";
	
	public static final String RECORD = "/avisoQuejaSugerencia/avisoQuejaSugerencia/{id}";
	
	public static final String TRANSFORM = "/avisoQuejaSugerencia/avisoQuejaSugerencia/transform";
	...
	public static final String ADD = "/avisoQuejaSugerencia/avisoQuejaSugerencia";
	public static final String UPDATE = "/avisoQuejaSugerencia/avisoQuejaSugerencia/{id}";
	public static final String DELETE = "/avisoQuejaSugerencia/avisoQuejaSugerencia/{id}";

...
import org.ciudadesabiertas.dataset.utils.AvisoQuejaSugGeoSearch;
import org.ciudadesabiertas.dataset.utils.AvisoQuejaSugResult;
import org.ciudadesabiertas.dataset.utils.AvisoQuejaSugSearch;
...
@RestController
@Api(value="Aviso Queja Sugerencia",description = "Conjunto de operaciones relacionadas con el conjunto de datos Avisos Quejas y Sugerencias"+SwaggerConstants.VOCABULARIO_A_HREF+AvisoQuejaSugConstants.serviceRequestVocabURL+SwaggerConstants.VOCABULARIO_A_HREF_END, tags= {"Aviso Queja Sugerencia"})
public class AvisoQuejaSugController extends GenericController implements CiudadesAbiertasController
{
	

	public static final String LIST = "/aviso-queja-sugerencia/aviso-queja-sugerencia";
	...
	//CMG: AvisoQuejaSug no va a tener busquedas agrupadas a fecha 2019-02-12
	//public static final String EQUIPAMIENTO_SEARCHGROUP = "/avisoQuejaSugerencia/groupBy";
	
	public static final String ADD = LIST;
	public static final String UPDATE = RECORD;
	public static final String DELETE = RECORD;
	
	public static final String MODEL_VIEW_LIST = "avisoQuejaSugerencia/list";
	public static final String MODEL_VIEW_ID = "avisoQuejaSugerencia/id";
	
	private static List<RequestType> listRequestType = new ArrayList<RequestType>();
	
	//Carga por defecto de las peticiones
	static {
		listRequestType.add(new RequestType("AQS_LIST", LIST, HttpMethod.GET,Constants.NO_AUTH));
		listRequestType.add(new RequestType("AQS_RECORD", RECORD, HttpMethod.GET,Constants.NO_AUTH));
		listRequestType.add(new RequestType("AQS_RANSFORM", TRANSFORM, HttpMethod.POST,Constants.NO_AUTH));
		
		listRequestType.add(new RequestType("AQS_ADD", ADD, HttpMethod.POST,Constants.BASIC_AUTH));
		listRequestType.add(new RequestType("AQS_UPDATE", UPDATE, HttpMethod.PUT,Constants.BASIC_AUTH));
		listRequestType.add(new RequestType("AQS_DELETE", DELETE, HttpMethod.DELETE,Constants.BASIC_AUTH));
		
	}
	
	public static List<String> availableFields=Util.extractPropertiesFromBean(AvisoQuejaSug.class);

	private static final Logger log = LoggerFactory.getLogger(AvisoQuejaSugController.class);
	
	
	@Autowired
	protected DatasetService<AvisoQuejaSug> dsService;
					...
					@ApiParam(value=SwaggerConstants.PARAM_PAGESIZE) String pageSize)
	{
		...
		return distinctSearch(request, search, availableFields, page, pageSize,getKey(),NO_HAY_SRID, SEARCH_DISTINCT, new AvisoQuejaSug(), new ObjectResult(),  dsService);
	...
	public ModelAndView listHTML(
			ModelAndView mv, HttpServletRequest request,AvisoQuejaSugSearch search, 
	...
	@ApiResponses({
	            @ApiResponse(code = 200, message = SwaggerConstants.RESULTADO_DE_BUSQUEDA_O_LISTADO,  response=AvisoQuejaSugResult.class),
	            @ApiResponse(code = 400, message = SwaggerConstants.PETICION_INCORRECTA,  response=ResultError.class),
	            @ApiResponse(code = 401, message = SwaggerConstants.NO_AUTORIZADO,  response=ResultError.class),
	            @ApiResponse(code = 500, message = SwaggerConstants.ERROR_INTERNO,  response=ResultError.class)
	   })
	@RequestMapping(value= {GEO_LIST,  VERSION_1+GEO_LIST}, method = {RequestMethod.GET})	
	public @ResponseBody ResponseEntity<?> geoList(HttpServletRequest request,	AvisoQuejaSugGeoSearch search, 
			...
			@RequestHeader HttpHeaders headersRequest)
	{
		...
		ResponseEntity list= geoList(request, search, fields, meters, page, pageSize, sort, srId, LIST, new AvisoQuejaSug(), new AvisoQuejaSugResult(), availableFields, getKey(),dsService);
	...
	public @ResponseBody ResponseEntity<?> list(HttpServletRequest request, AvisoQuejaSugSearch search, 
			@RequestParam(value = Constants.FIELDS, defaultValue = "", required = false) 
				@ApiParam(value=SwaggerConstants.PARAM_FIELDS) String fields, 
			...
			@RequestHeader HttpHeaders headersRequest)
	{
		...
		RSQLVisitor<CriteriaQuery<AvisoQuejaSug>, EntityManager> visitor = new JpaCriteriaQueryVisitor<AvisoQuejaSug>();
		
		ResponseEntity list= list(request, search, fields, rsqlQ, page, pageSize, sort, srId, LIST,new AvisoQuejaSug(), new AvisoQuejaSugResult(), 
	...
	public @ResponseBody ResponseEntity<?> listHead(HttpServletRequest request, AvisoQuejaSugSearch search, 
			@RequestParam(value = Constants.FIELDS, defaultValue = "", required = false) 
				@ApiParam(value=SwaggerConstants.PARAM_FIELDS) String fields, 
			@RequestParam(value = Constants.RSQL_Q, defaultValue = "", required = false) 
				@ApiParam(value=SwaggerConstants.PARAM_Q) String rsqlQ, 
	...
	@ApiResponses({
	            @ApiResponse(code = 201, message = SwaggerConstants.RESULTADO_DE_INSERCION,  response=AvisoQuejaSugResult.class),
	            @ApiResponse(code = 400, message = SwaggerConstants.PETICION_INCORRECTA,  response=ResultError.class),
	            @ApiResponse(code = 401, message = SwaggerConstants.NO_AUTORIZADO,  response=ResultError.class),
	            @ApiResponse(code = 409, message = SwaggerConstants.EL_RECURSO_YA_EXISTE,  response=ResultError.class),
	            @ApiResponse(code = 500, message = SwaggerConstants.ERROR_INTERNO,  response=ResultError.class)
	...
	public @ResponseBody ResponseEntity<?> add(			
			@ApiParam(required = true, name = Constants.OBJETO, value = SwaggerConstants.PARAM_AVISOQUEJASUG_TEXT) 			
			@RequestBody AvisoQuejaSug obj 
			)
	{
		...
		return add(obj, AvisoQuejaSugController.class.getName(), ADD, dsService,getKey());
	...
	@ApiResponses({
	            @ApiResponse(code = 201, message = SwaggerConstants.RESULTADO_DE_MODIFICACION,  response=AvisoQuejaSugResult.class),
	            @ApiResponse(code = 400, message = SwaggerConstants.PETICION_INCORRECTA,  response=ResultError.class),
	            @ApiResponse(code = 401, message = SwaggerConstants.NO_AUTORIZADO,  response=ResultError.class),
	            @ApiResponse(code = 409, message = SwaggerConstants.EL_RECURSO_YA_EXISTE,  response=ResultError.class),
	            @ApiResponse(code = 500, message = SwaggerConstants.ERROR_INTERNO,  response=ResultError.class)
	...
	public @ResponseBody ResponseEntity<?> update(
			@ApiParam(required = true, name = Constants.IDENTIFICADOR, value = SwaggerConstants.PARAM_ID_TEXT+SwaggerConstants.PARAM_ID_AVI_QUE_SUG) 
			...
			@RequestBody AvisoQuejaSug obj)
	{
		...
		return update(id, obj, AvisoQuejaSugController.class.getName(), UPDATE, dsService,getKey());
	}
	...
	@ApiResponses({
	            @ApiResponse(code = 200, message = SwaggerConstants.RESULTADO_DE_DELETE,  response=AvisoQuejaSugResult.class),
	            @ApiResponse(code = 400, message = SwaggerConstants.PETICION_INCORRECTA,  response=ResultError.class),
	            @ApiResponse(code = 401, message = SwaggerConstants.NO_AUTORIZADO,  response=ResultError.class),
	            @ApiResponse(code = 409, message = SwaggerConstants.EL_RECURSO_YA_EXISTE,  response=ResultError.class),
	            @ApiResponse(code = 500, message = SwaggerConstants.ERROR_INTERNO,  response=ResultError.class)
			...
			@PathVariable(Constants.IDENTIFICADOR) String id)
	{
		...
		return delete(id, new AvisoQuejaSug(), AvisoQuejaSugController.class.getName(), DELETE, dsService,getKey());
	}
	...
	@ApiResponses({
	            @ApiResponse(code = 200, message = SwaggerConstants.RESULTADO_DE_FICHA,  response=AvisoQuejaSugResult.class),
	            @ApiResponse(code = 400, message = SwaggerConstants.PETICION_INCORRECTA,  response=ResultError.class),
	            @ApiResponse(code = 401, message = SwaggerConstants.NO_AUTORIZADO,  response=ResultError.class),
	            @ApiResponse(code = 409, message = SwaggerConstants.EL_RECURSO_YA_EXISTE,  response=ResultError.class),
	            @ApiResponse(code = 500, message = SwaggerConstants.ERROR_INTERNO,  response=ResultError.class)
	...
	public @ResponseBody ResponseEntity<?> record(HttpServletRequest request, @PathVariable @ApiParam(required = true, value=SwaggerConstants.PARAM_ID+SwaggerConstants.PARAM_ID_AVI_QUE_SUG) String id,
			@RequestParam(value = Constants.SRID, defaultValue = Constants.SRID_DEFECTO, required = false) @ApiParam(value=SwaggerConstants.PARAM_SRID, allowableValues=Constants.SUPPORTED_SRIDS)  String srId)
	{
		...
		ResponseEntity record = record(request, id, new AvisoQuejaSug(),new AvisoQuejaSugResult(), srId, AvisoQuejaSugController.class.getName(), RECORD, dsService,getKey());
	...
	public @ResponseBody ResponseEntity<?> recordHead(HttpServletRequest request, @PathVariable @ApiParam(required = true, value=SwaggerConstants.PARAM_ID+SwaggerConstants.PARAM_ID_AVI_QUE_SUG) String id,
			@RequestParam(value = Constants.SRID, defaultValue = Constants.SRID_DEFECTO, required = false) @ApiParam(value=SwaggerConstants.PARAM_SRID, allowableValues=Constants.SUPPORTED_SRIDS)  String srId	)
	{
	...
	@ApiResponses({
		...
		return transform(obj, AvisoQuejaSugController.class.getName(), TRANSFORM);
	...
	{
		return AvisoQuejaSugConstants.KEY;
	}

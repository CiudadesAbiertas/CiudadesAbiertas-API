...
public class CallejeroViaDataRSQLTest
{
	...
	{
		String paramField = "q";
		String value = "title=='Bravo Murillo'";
		JSONArray records = TestUtils.extractRecords(listURL, paramField, value, mockMvc);
		assertTrue(records.size() == 1);
	}
	...
	{
		String paramField = "q";
		String value = "municipioId==28079 and id=='114600'";
		JSONArray records = TestUtils.extractRecords(listURL, paramField, value, mockMvc);
		assertTrue(records.size() == 1);
	}
	...
	{				
		String paramField = "q";
		String value = "estado=='vigente' and id=='114600'";		
		JSONArray records = TestUtils.extractRecords(listURL, paramField, value, mockMvc);
		assertTrue(records.size() == 1);
	}

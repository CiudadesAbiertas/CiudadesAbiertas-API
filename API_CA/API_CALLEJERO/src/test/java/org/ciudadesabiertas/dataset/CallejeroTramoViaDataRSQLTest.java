...
public class CallejeroTramoViaDataRSQLTest
{
	...
	{
		String paramField = "q";
		String value = "title=='Tramo comprendido entre el número 27 hasta el 27 de la/del Calle Maudes'";
		JSONArray records = TestUtils.extractRecords(listURL, paramField, value, mockMvc);
		assertTrue(records.size() == 1);
	}
	...
	{
		String paramField = "q";
		String value = "title=='*Calle Maudes*'";
		JSONArray records = TestUtils.extractRecords(listURL, paramField, value, mockMvc);
	...
	{
		String paramField = "q";
		String value = "municipioId==28079 and id=='TRA000014'";
		JSONArray records = TestUtils.extractRecords(listURL, paramField, value, mockMvc);
		assertTrue(records.size() == 1);
	}
	...
	{				
		String paramField = "q";
		String value = "estado=='vigente' and id=='TRA000014'";		
		JSONArray records = TestUtils.extractRecords(listURL, paramField, value, mockMvc);
		assertTrue(records.size() == 1);
	}
	...
	{				
		String paramField = "q";
		String value = "juntaAdministrativa=='Chamberí' and id=='TRA000014'";
		long records = TestUtils.extractTotal(listURL, paramField, value, mockMvc);
	...
	{	
		String paramField = "q";
		String value = "numeroFinTramo=='27'";
		long records = TestUtils.extractTotal(listURL, paramField, value, mockMvc);
		assertTrue(records == 1);
	}
	...
	{	
		String paramField = "q";
		String value = "numeroInicioTramo=='27'";
		long records = TestUtils.extractTotal(listURL, paramField, value, mockMvc);
		assertTrue(records == 1);
	}

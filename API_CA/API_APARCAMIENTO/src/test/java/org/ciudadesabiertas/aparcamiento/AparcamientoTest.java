...
public class AparcamientoTest {
	...
	private static final Logger log = LoggerFactory.getLogger(AparcamientoTest.class);
	
	@Autowired
	private WebApplicationContext wac;

	@Autowired
	private DatasetService<Equipamiento> dsService;	
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<Equipamiento> users = dsService.basicQuery(AparcamientoConstants.KEY,Equipamiento.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("aparcamientoController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(AparcamientoController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
    	String equipamientoADD = "{"    			
        	    ...
        	    +"\"tipoEquipamiento\" : \""+AparcamientoConstants.TIPO_EQUIPAMIENTO+"\","
        	    +"\"municipioId\" : \"28006\","
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(AparcamientoController.ADD)
    ...
    public void test07_Update() throws Exception {
    	String id ="TEST01_EQ0001";
    	String obj = "{"    			
    			+"\"id\" : \""+id+"\","
        	    +"\"title\" : \" XXXM ODIFICACION XXXX Aula de Educación Ambiental\","
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(AparcamientoController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(AparcamientoController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(AparcamientoController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test13_Delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete(AparcamientoController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AparcamientoController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AparcamientoController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AparcamientoController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(AparcamientoController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	String obj = "{"    			
    			+"\"id\" : \""+id+"\","
        	    +"\"title\" : \" XXX Aparcamiento mixto. Arquitecto Ribera\","
        	    +"\"description\" : \" XXXXX XXXXXX MODIFICACION XXXX XXXXX PRUEBAS XXXXXX Datos de interés Servicios principales Equipamiento ambiental situado en el Jardín de la Vega donde se desarrollan actividades y programas relacionados con la Educación Ambiental. Proyecto Coches compartidos Accesos Coche Autobús:  151 / 152C  / 153  /154C / 158 / 166      Metro. Estación La Moraleja Más información sobre transportes  Horario Del 1/10 al 31/03: lunes a viernes de 16:30 a 18:30 h. Del 1/04 al 30/06: lunes a viernes de 17:00 a 20:00 h. Del 1/07 al 30/09: lunes a viernes de 10:00 a 13:00 h.\","
        	    +"\"tipoEquipamiento\" : \""+AparcamientoConstants.TIPO_EQUIPAMIENTO+"\","
        	    +"\"municipioId\" : \"28079\","
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(AparcamientoController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(AparcamientoController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(AparcamientoController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    ...
    @Test
   	...
   	{	
           ...
           this.mockMvc.perform(MockMvcRequestBuilders.get(AparcamientoController.GEO_LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
   	}
    ...
    public void test23_List_Distinct_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(AparcamientoController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(AparcamientoController.LIST, true,  mockMvc);
    ...
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,AparcamientoController.LIST);        
    ...
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(AparcamientoController.LIST+"/"+"EQAP0001", true, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

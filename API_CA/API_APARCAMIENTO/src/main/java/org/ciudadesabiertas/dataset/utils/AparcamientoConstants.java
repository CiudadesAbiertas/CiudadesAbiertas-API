 ...
 *
 */
public class AparcamientoConstants
{
	public static final String KEY="aparcamiento";
	public static final String TIPO_EQUIPAMIENTO_FIELD = "tipoEquipamiento";
	public static final String TIPO_EQUIPAMIENTO = EnumTipoEquipamiento.APARCAMIENTO.getTipo();

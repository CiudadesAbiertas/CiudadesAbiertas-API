...
public class BicicletaPublicaPuntoPasoTestFK {
    ...
    public void test01_Add() throws Exception {
    	...
    	if (activeFK == false) {
			...
			this.mockMvc.perform(
					MockMvcRequestBuilders.post(BicicletaPublicaPuntoPasoController.ADD)

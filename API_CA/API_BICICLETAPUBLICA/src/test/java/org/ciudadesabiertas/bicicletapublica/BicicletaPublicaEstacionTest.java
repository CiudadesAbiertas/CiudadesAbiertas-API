...
public class BicicletaPublicaEstacionTest {
	
	private static final Logger log = LoggerFactory.getLogger(BicicletaPublicaEstacionTest.class);
	
	@Autowired
	private WebApplicationContext wac;

	@Autowired
	private DatasetService<BicicletaPublicaEstacion> dsService;	
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<BicicletaPublicaEstacion> items = dsService.basicQuery(BicicletaPublicaConstants.KEY,BicicletaPublicaEstacion.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("bicicletaPublicaEstacionController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaEstacionController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(BicicletaPublicaEstacionController.ADD)
    ...
    public void test07_Update() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(BicicletaPublicaEstacionController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test08_Update_NO_OK_400() throws Exception {
    	...
    	String estacionUPDATE = "{"      	
    			+"}";
    	
    	 
        this.mockMvc.perform(MockMvcRequestBuilders.put(BicicletaPublicaEstacionController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(estacionUPDATE))	
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaEstacionController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(BicicletaPublicaEstacionController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(BicicletaPublicaEstacionController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(BicicletaPublicaEstacionController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(BicicletaPublicaEstacionController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaEstacionController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(BicicletaPublicaEstacionController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(estacionTransform))	
...
//    			+ "   \"fechaAlta\": \"2019-12-01T00:00:00\",\r\n"
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (BicicletaPublicaEstacion.class).getDeclaredFields();
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaEstacionController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaEstacionController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    
    @Test    
    public void test23_List_Distinct_200() throws Exception {
    	String sort="?field=id";
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaEstacionController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(BicicletaPublicaEstacionController.LIST, true, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }
    
    @Test
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,BicicletaPublicaEstacionController.LIST);        
        this.mockMvc.perform(MockMvcRequestBuilders.get(theURI)).andExpect(MockMvcResultMatchers.status().is(200));    	    	
    }

    @Test
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(BicicletaPublicaEstacionController.LIST+"/"+"EST01", true, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

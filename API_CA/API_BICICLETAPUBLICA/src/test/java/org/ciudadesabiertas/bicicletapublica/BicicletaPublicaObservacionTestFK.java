...
public class BicicletaPublicaObservacionTestFK {
    ...
    public void test01_Add() throws Exception {
    	...
    	if (activeFK == false) {
			...
			this.mockMvc.perform(
					MockMvcRequestBuilders.post(BicicletaPublicaObservacionController.ADD)
    ...
    public void test02_Add_ERROR_FK1() throws Exception {
    	...
    	if (activeFK == false) {
			...
			String id ="TEST02_OBS0001";    	
	    	String item = " {\n"
	    			+ "    \"id\": \""+id+"\",\n" 
	    			+ "   \"madeBySensor\": \"EST01_KO\",\r\n"
	    			+ "   \"observedPropertyTitle\": \"Anclajes libres\",\r\n"
	    			+ "   \"observedPropertyId\": \"anclajesLibres\",\r\n"
	    			+ "   \"resultTime\": \"2020-01-28T11:00:00\",\r\n"
	    			+ "   \"hasSimpleResult\": \"5\",\r\n"

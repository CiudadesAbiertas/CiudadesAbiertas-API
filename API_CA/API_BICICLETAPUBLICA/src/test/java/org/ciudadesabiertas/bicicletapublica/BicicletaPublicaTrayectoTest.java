...
public class BicicletaPublicaTrayectoTest {
	
	private static final Logger log = LoggerFactory.getLogger(BicicletaPublicaTrayectoTest.class);
	
	@Autowired
	private WebApplicationContext wac;

	@Autowired
	private DatasetService<BicicletaPublicaTrayecto> dsService;	
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<BicicletaPublicaTrayecto> items = dsService.basicQuery(BicicletaPublicaConstants.KEY,BicicletaPublicaTrayecto.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("bicicletaPublicaTrayectoController"));
    }
    
    @Test    
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaTrayectoController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(BicicletaPublicaTrayectoController.ADD)
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaTrayectoController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(BicicletaPublicaTrayectoController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(BicicletaPublicaTrayectoController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(BicicletaPublicaTrayectoController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(BicicletaPublicaTrayectoController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaTrayectoController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }

    @Test    
    public void test18_Post_Transform() throws Exception {
    	String id ="TEST01_TRASFORM_TRA0001";
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(BicicletaPublicaTrayectoController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
...
//    			+ "   \"startDate\": \"2020-01-09T08:00:00\",\r\n"
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFieldsTmp = (BicicletaPublicaTrayecto.class).getDeclaredFields();
    	Field[] declaredFields = {declaredFieldsTmp[0], declaredFieldsTmp[1]};
    ...
    public void test21_List_Sort_200() throws Exception {
    	String sort="?sort=-id,startDate";
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaTrayectoController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaTrayectoController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    
    @Test    
    public void test23_List_Distinct_200() throws Exception {
    	String sort="?field=id";
        this.mockMvc.perform(MockMvcRequestBuilders.get(BicicletaPublicaTrayectoController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(BicicletaPublicaTrayectoController.LIST, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }
    
    @Test
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,BicicletaPublicaTrayectoController.LIST);        
        this.mockMvc.perform(MockMvcRequestBuilders.get(theURI)).andExpect(MockMvcResultMatchers.status().is(200));    	    	
    }

    @Test
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(BicicletaPublicaTrayectoController.LIST+"/"+"TRA01", mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

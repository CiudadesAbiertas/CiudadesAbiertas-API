...
public class BicicletaPublicaObservacionDataTest
{
	...
	private String listURL=BicicletaPublicaObservacionController.LIST;
	...
	public void test_Busqueda_resultTime() throws Exception
	{
		...
		String value = "2020-01-09T12:14:41";
	...
	{
		String paramField="hasSimpleResult";
	...
	public void test_Busqueda_quality() throws Exception
	{
		...
		String value = "número de anclajes";
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		String value = "madeBySensor";

		long total = TestUtils.extractTotalDistinct(BicicletaPublicaObservacionController.SEARCH_DISTINCT, paramField, value, mockMvc);

...
public class BicicletaPublicaUsuarioDataTest
{
	...
	private String listURL=BicicletaPublicaUsuarioController.LIST;
	...
	@Test
	public void test_Busqueda_anioNacimiento() throws Exception
	{
		String paramField="anioNacimiento";
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		long total = TestUtils.extractTotalDistinct(BicicletaPublicaUsuarioController.SEARCH_DISTINCT, paramField, value, mockMvc);

...
public class BicicletaPublicaEstacionController extends GenericController implements CiudadesAbiertasController 
{
			...
			@RequestHeader HttpHeaders headersRequest)
	{
		...
		ResponseEntity list= geoList(request, search, fields, meters, page, pageSize, sort, LIST, new BicicletaPublicaEstacion(), new BicicletaPublicaEstacionResult(), availableFields, getKey(),service);

...
public class EquipamientoDataTest
{
	...
	public void test_Busqueda_Title() throws Exception	
	{
		...
		String [] value = {"*Casa de*",EquipamientoConstants.TIPO_EQUIPAMIENTO};
	...
	public void test_Busqueda_description() throws Exception
	{
		...
		String value = "*Datos de interés Descripción*";
	...
	public void test_Busqueda_address() throws Exception
	{
		...
		String value = "CL RUPERTO CHAPI 18";
	...
	public void test_Busqueda_X() throws Exception
	{
		...
		String [] paramField= {"xETRS89",EquipamientoConstants.TIPO_EQUIPAMIENTO_FIELD};

		//TIPO_EQUIPAMIENTO
		String [] value = {"444333.78925",EquipamientoConstants.TIPO_EQUIPAMIENTO};
	...
	public void test_Busqueda_Y() throws Exception
	{
		...
		String [] paramField= {"yETRS89",EquipamientoConstants.TIPO_EQUIPAMIENTO_FIELD};

		//TIPO_EQUIPAMIENTO
		String [] value = {"4489188.88773",EquipamientoConstants.TIPO_EQUIPAMIENTO};
	...
	public void test_Busqueda_email() throws Exception
	{
		...
		String value = "centrodeformacion@aytoalcobendas.org";
	...
	public void test_Busqueda_url() throws Exception
	{
		...
		String value = "http://conecta.alcobendas.org/";
	...
	public void test_Busqueda_title_comodines_sin_acentos() throws Exception
	{
		...
		//TIPO_EQUIPAMIENTO = Escuela Infantil
		String [] value = {"*Publica Municipal*",EquipamientoConstants.TIPO_EQUIPAMIENTO};	
	...
	public void test_Busqueda_id_getLatitud_getLongitud() throws Exception
	{
		...
		String [] value = {"EPSG:23030","EQ0001"};
	...
	public void test_Busqueda_geo() throws Exception
	{
		...
		String [] value = {"444333","4489188","50"};
		JSONArray records = TestUtils.extractRecords(EquipamientoController.GEO_LIST, paramField, value, mockMvc);
		assertTrue(records.size() == 2);	
	}
	...
	public void test_Busqueda_geo_sort_id() throws Exception
	{
		...
		String [] value = {"444333","4489188","50","id"};
		JSONArray records = TestUtils.extractRecords(EquipamientoController.GEO_LIST, paramField, value, mockMvc);
		assertTrue(records.size() == 2);	
	}
	...
	public void test_Busqueda_geo_fields() throws Exception
	{
		...
		String [] value = {"444333","4489188","50","id,title,distance"};
		JSONArray records = TestUtils.extractRecords(EquipamientoController.GEO_LIST, paramField, value, mockMvc);
		assertTrue(records.size() == 2);	
	}
	...
	public void test_Busqueda_distinct() throws Exception
	{
		...
		String value = "openingHours";

		long total = TestUtils.extractTotalDistinct(EquipamientoController.SEARCH_DISTINCT, paramField, value, mockMvc);
	...
	public void test_Busqueda_openingHours() throws Exception
	{
		...
		//TIPO_EQUIPAMIENTO = Equipamiento Cultural
		String [] value = {"Sin Horario",EquipamientoConstants.TIPO_EQUIPAMIENTO};

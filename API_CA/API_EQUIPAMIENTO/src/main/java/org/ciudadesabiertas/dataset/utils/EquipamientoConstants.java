 ...
 *
 */
public class EquipamientoConstants
{
	public static final String KEY="equipamiento";
	public static final String TIPO_EQUIPAMIENTO_FIELD = "tipoEquipamiento";
	public static final String TIPO_EQUIPAMIENTO = EnumTipoEquipamiento.EQUIPAMIENTO.getTipo();

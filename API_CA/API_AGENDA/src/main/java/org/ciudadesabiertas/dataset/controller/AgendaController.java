...
@RestController
@Api(value="AgendaCultural",description = "Conjunto de operaciones relacionadas con el conjunto de datos Agenda Cultural", tags= {"Agenda Cultural"})
public class AgendaController extends GenericController implements CiudadesAbiertasController 
{
	public static final String LIST = "/agendaCultural/evento";
	
	public static final String SEARCH_DISTINCT = LIST+"/distinct";
	
	public static final String RECORD = "/agendaCultural/evento/{id}";
	
	public static final String TRANSFORM = "/agendaCultural/evento/transform";
	
	public static final String ADD = "/agendaCultural/evento";
	public static final String UPDATE = "/agendaCultural/evento/{id}";
	public static final String DELETE = "/agendaCultural/evento/{id}";

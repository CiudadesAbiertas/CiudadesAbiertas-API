...
public class AgendaTest {
	...
	private static final Logger log = LoggerFactory.getLogger(AgendaTest.class);
	
	@Autowired
	private WebApplicationContext wac;

	@Autowired
	private DatasetService<Agenda> dService;
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<Agenda> users = dService.basicQuery(AgendaConstants.KEY,Agenda.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("agendaController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgendaController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
    	...
    	String agendaADD = "{"    			
    			+"\"id\" : \""+id+"\","
    		    +"\"title\" : \"ALTA NUEVA XXXXXX. Octubre 2018-Enero2019\","
    		    +"\"municipioId\" : \"28006\","
    		    +"\"municipioTitle\" : \"Alcobendas\","
    		    +"\"description\" : \"Datos de interés Descripción XXXX XXXX XXXXX\","
    		    ...
    		    +"\"equipamiento\" : \"Teatro Auditorio Ciudad de Alcobendas\","
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(AgendaController.ADD)
    ...
    public void test07_Update() throws Exception {
    	...
    	String obj = "{"    			
    			+"\"id\" : \""+id+"\","
    		    +"\"title\" : \"MODIFICACION NUEVA  MODIF XXXXXX. Octubre 2018-Enero2019\","
    		    +"\"municipioId\" : \"28006\","
    		    +"\"municipioTitle\" : \"Alcobendas\","
    		    +"\"description\" : \"Datos de interés Descripción MODIFICACION XXXX XXXX XXXXX\","
    		    +"\"fechaInicio\" : \"2018-10-06T00:00:00\","
    		    +"\"fechaFin\" : \"2019-01-23T23:59:59\","
    		    +"\"tipoEvento\" : \"Teatro, Música y Danza,Teatro y Danza,Música,El Público,Abono General,Abono Alternativo,Abono Familia\","
    		    +"\"tipoPublico\" : \"Infancia y Adolescencia,Público general\","
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(AgendaController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgendaController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(AgendaController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test13_Delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete(AgendaController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AgendaController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AgendaController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(AgendaController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgendaController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	String obj = "{"    			
    			+"\"id\" : \""+id+"\","
    		    +"\"title\" : \"TRANSFORMACION NUEVA  TRANSFORMACION XXXXXX. Octubre 2018-Enero2019\","
    		    +"\"municipioId\" : \"28006\","
    		    +"\"municipioTitle\" : \"Alcobendas\","
    		    +"\"description\" : \"Datos de interés Descripción TRANSFORMACION XXXX XXXX XXXXX\","
    		    +"\"fechaInicio\" : \"2018-10-06T00:00:00\","
    		    +"\"fechaFin\" : \"2019-01-23T23:59:59\","
    		    +"\"tipoEvento\" : \"Teatro, Música y Danza,Teatro y Danza,Música,El Público,Abono General,Abono Alternativo,Abono Familia\","
    		    +"\"tipoPublico\" : \"Infancia y Adolescencia,Público general\","
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(AgendaController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (Agenda.class).getDeclaredFields();
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgendaController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgendaController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    
    @Test    
    public void test23_List_Distinct_200() throws Exception {
    	String sort="?field=id";
        this.mockMvc.perform(MockMvcRequestBuilders.get(AgendaController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(AgendaController.LIST, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }
    
    @Test
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,AgendaController.LIST);        
        this.mockMvc.perform(MockMvcRequestBuilders.get(theURI)).andExpect(MockMvcResultMatchers.status().is(200));    	    	
    }

    @Test
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(AgendaController.LIST+"/"+"AG0001", mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

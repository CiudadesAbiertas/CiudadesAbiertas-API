 ...
 *
 */
public class InstalacionDepConstants
{
	public static final String KEY="instalacionDep";
	public static final String TIPO_EQUIPAMIENTO_FIELD = "tipoEquipamiento";
	public static final String TIPO_EQUIPAMIENTO = EnumTipoEquipamiento.DEPORTES.getTipo();

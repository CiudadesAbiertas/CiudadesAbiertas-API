 ...
 *
 */
public class CubeDsdDimensionSearch extends CubeDsdDimension implements  Serializable, DatasetSearch<CubeDsdDimension> {

	@JsonIgnore
	private static final long serialVersionUID = -1286906960224435790L;

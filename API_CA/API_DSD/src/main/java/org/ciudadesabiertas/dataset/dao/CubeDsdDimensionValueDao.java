 ...
 */
@Repository
public class CubeDsdDimensionValueDao  {
	...
	private static final Logger log = LoggerFactory.getLogger(CubeDsdDimensionValueDao.class);
	...
	public List<CubeDsdDimensionValue> findByDimension(String key, CubeDsdDimension cubeDsdDimension) {
		...
		List<CubeDsdDimensionValue> result = new ArrayList<CubeDsdDimensionValue>();		
		
		Session opennedSession = null;
		
		Query query = null;
		String queryText="FROM CubeDsdDimensionValue where cubeDsdDimension = :cDsdDimension";
		if (multipleSessionFactory.getKeys().contains(key))
		{
			log.debug(LiteralConstants.TXT_CUSTOM_CONECT);
			opennedSession = multipleSessionFactory.getFactories().get(key).openSession();
	...
	public List<CubeDsdDimensionValue>  findByDimensionAndId(String key, CubeDsdDimension cubeDsdDimension, String id) {
		...
		Query query = null;
		String queryText="FROM CubeDsdDimensionValue where cubeDsdDimension = :cDsdDimension and id like :id";
		if (multipleSessionFactory.getKeys().contains(key))
		{
			log.debug(LiteralConstants.TXT_CUSTOM_CONECT);
			opennedSession = multipleSessionFactory.getFactories().get(key).openSession();

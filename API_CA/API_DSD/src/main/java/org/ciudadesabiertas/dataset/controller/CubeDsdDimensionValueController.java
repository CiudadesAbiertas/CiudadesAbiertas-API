...
{	
	...
	public @ResponseBody ResponseEntity<?> listHead(HttpServletRequest request,@PathVariable String dimensionId,			
			@RequestHeader HttpHeaders headersRequest)
	{
	...
	public @ResponseBody ResponseEntity<?> findByDimensionAndId(HttpServletRequest request, @PathVariable String dimensionId,  @PathVariable String id)
	{
	...
	public @ResponseBody ResponseEntity<?> recordHead(HttpServletRequest request, @PathVariable String dimensionId,  @PathVariable String id)
	{

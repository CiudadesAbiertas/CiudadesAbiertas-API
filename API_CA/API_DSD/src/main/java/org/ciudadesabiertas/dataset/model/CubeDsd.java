...
@Rdf(contexto = Context.QB, propiedad = "DataStructureDefinition")
@PathId(value="/data-cube/data-structure-definition")
public class CubeDsd  implements java.io.Serializable, RDFModel {
	...
	@Transient
	@RdfList(propiedad=Context.QB_URI+"component")
	@RdfBlankNode(propiedad=Context.QB_URI+"measure")
	...
	{		
		...
		this.dimension.addAll(copia.dimension);		
		this.measure = new ArrayList<String>();
		this.measure.addAll(copia.measure);
		
	}
	
	public CubeDsd(CubeDsd copia, List<String> attributesToSet)
	{
		...
		if (attributesToSet.contains("dimension")) {
			this.dimension = new ArrayList<String>();
			this.dimension.addAll(copia.dimension);		
		}
		
		if (attributesToSet.contains("measure")) {
			this.measure = new ArrayList<String>();
			this.measure.addAll(copia.measure);		
		}
	...
	public void setMeasure(List<String> measure) {
		 this.measure=new ArrayList<String>();
		 this.measure.addAll(measure);
	}
		
	@Override
	public String toString() {
		return "DataCube [ikey=" + ikey + ", id=" + id + ", title=" + title  +", notation=" + notation  + "]";
	}
	...
	{
		return (T) cloneClass((CubeDsd) copia, listado);
	}
	
	public CubeDsd cloneClass(CubeDsd copia, List<String> attributesToSet) {
		CubeDsd obj = new CubeDsd(copia,attributesToSet);		
		return obj;
	}

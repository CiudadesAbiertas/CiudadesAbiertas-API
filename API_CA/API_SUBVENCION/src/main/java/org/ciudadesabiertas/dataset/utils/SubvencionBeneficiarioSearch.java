 ...
 *
 */
public class SubvencionBeneficiarioSearch extends SubvencionBeneficiario implements  Serializable, DatasetSearch<SubvencionBeneficiario> {

	@JsonIgnore
	private static final long serialVersionUID = -5266206960220335790L;

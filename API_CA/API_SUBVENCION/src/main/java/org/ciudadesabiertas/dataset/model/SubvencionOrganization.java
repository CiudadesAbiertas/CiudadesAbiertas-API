...
@Entity
@ApiModel
@Table(name = "subvencion_organization")
@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonPropertyOrder(alphabetic = false)
@JsonIgnoreProperties({ Constants.IKEY })
@JacksonXmlRootElement(localName = Constants.RECORD)
@Rdf(contexto = Context.ORG, propiedad = "Organization")
@PathId(value = "/subvencion/organization")
public class SubvencionOrganization implements java.io.Serializable, RDFModel, ICallejero {
	...
	public SubvencionOrganization() {
		
	}

	public SubvencionOrganization(SubvencionOrganization copia)
	{		
	...
	public SubvencionOrganization(SubvencionOrganization copia, List<String> attributesToSet)
	{
	...
	{
		return (T) cloneClass((SubvencionOrganization) copia, listado);
	}
	
	public SubvencionOrganization cloneClass(SubvencionOrganization copia, List<String> attributesToSet) {

		SubvencionOrganization obj = new SubvencionOrganization(copia,attributesToSet);		
	...
	public String toString() {
		return "SubvencionOrganization [id=" + id + ", title=" + title + ", url=" + url

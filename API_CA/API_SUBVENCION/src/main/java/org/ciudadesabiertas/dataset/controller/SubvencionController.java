...
public class SubvencionController extends GenericController implements CiudadesAbiertasController
{
	...
	public static final String RECORD = "/subvencion/subvencion/{id}";

	public static final String SEARCHGROUP = "/subvencion/subvencion/groupBy";
	
	public static final String SEARCH_DISTINCT = LIST+"/distinct";
	
	public static final String ADD = "/subvencion/subvencion";
	public static final String UPDATE = "/subvencion/subvencion/{id}";
	public static final String DELETE = "/subvencion/subvencion/{id}";
	
	public static final String TRANSFORM = "/subvencion/subvencion/transform";
	
	
	public static final String MODEL_VIEW_LIST = "subvencion/list";
	public static final String MODEL_VIEW_ID = "subvencion/id";
	public static final String MODEL_VIEW_GROUPBY = "subvencion/groupby";

...
{	
	...
	public void test_Busqueda_Agrupada_01() throws Exception
	{
		...
		String params="fields=areaId,sum(importeTotalConcedido)&group=areaId&sort=-sum(importeTotalConcedido)";
	...
	public void test_Busqueda_Agrupada_02() throws Exception
	{
		...
		String params="fields=EXTRACT(YEAR FROM fechaAcuerdo),EXTRACT(MONTH FROM fechaAcuerdo),sum(importeTotalConcedido)&group=EXTRACT(YEAR FROM fechaAcuerdo),EXTRACT(MONTH FROM fechaAcuerdo)";

...
public class SubvencionBeneficiarioDataAgrupadasTest
{	
	@Autowired
	...
	private String listURL=SubvencionBeneficiarioController.SEARCHGROUP;
	...
	public void test_Busqueda_Agrupada_01() throws Exception
	{
		...
		String params="fields=tieneSubvencion,sum(importeAdjudicado)&group=tieneSubvencion&sort=-sum(importeAdjudicado)";

...
public class SubvencionTest {
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<SubvencionV1> users = service.basicQuery(SubvencionConstants.KEY,SubvencionV1.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("subvencionControllerV1"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionControllerV1.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test04_Add() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(SubvencionControllerV1.ADD)
    ...
    public void test07_Update() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(SubvencionControllerV1.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionControllerV1.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(SubvencionControllerV1.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test13_Delete() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete(SubvencionControllerV1.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(SubvencionControllerV1.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(SubvencionControllerV1.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(SubvencionControllerV1.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionControllerV1.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_transform() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(SubvencionControllerV1.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (SubvencionV1.class).getDeclaredFields();
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionControllerV1.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionControllerV1.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    
    @Test    
    public void test23_List_Distinct_200() throws Exception {
    	String sort="?field=id";
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionControllerV1.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    ...
    public void test25_List_Formatos_200() throws Exception {    	
    	...
    	boolean checkAllFormats=TestUtils.checkFormatURIs(SubvencionControllerV1.LIST, mockMvc);
     	assertTrue(checkAllFormats);    	    	
    }

    @Test
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,SubvencionControllerV1.LIST);        
    ...
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(SubvencionControllerV1.LIST+"/"+"S0001", mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }
}

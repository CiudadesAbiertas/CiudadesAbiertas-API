...
public class SubvencionBeneficiarioTestFK {
    ...
    public void test_01_add() throws Exception {
    	...
    	{    	
    	  String jsonItem = "{\r\n"
    	  	...
    	  	+ "      \"tieneSubvencion\": \"SUBTESTKO\",\r\n"
    	  	+ "      \"tieneBeneficiario\": \"0909090L\"\r\n"
    	  	+ "    }";  	    	    	
    	...
    	{    	
    	  String jsonItem = "{\r\n"
      	  ...
      	  jsonItem = new String (jsonItem.getBytes(),"UTF-8");	    	
	     	 ...
	     	 this.mockMvc.perform(MockMvcRequestBuilders.put(SubvencionBeneficiarioController.ADD+"/"+"SUB1")
	         		.contentType(MediaType.APPLICATION_JSON)
	     	        .content(jsonItem)).andExpect(MockMvcResultMatchers.status().isConflict());
    	}

...
public class SubvencionBeneficiarioUtilTest
{
	...
	public void constructorCopia() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		...
		SubvencionBeneficiario mappedObj = mapper.readValue(testJSON, SubvencionBeneficiario.class);
		SubvencionBeneficiario CallejeroTramo = new SubvencionBeneficiario(mappedObj);
	...
	public void constructorCampos() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		...
		SubvencionBeneficiario CallejeroTramo = new SubvencionBeneficiario(mappedObj, listaCampos);

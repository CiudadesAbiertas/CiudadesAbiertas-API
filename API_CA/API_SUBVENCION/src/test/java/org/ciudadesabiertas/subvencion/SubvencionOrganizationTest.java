...
public class SubvencionOrganizationTest {
	
	private static final Logger log = LoggerFactory.getLogger(SubvencionOrganizationTest.class);
	
	@Autowired
	private WebApplicationContext wac;

    @Autowired
    private DatasetService<SubvencionOrganization> service;
    ...
    public void test01_Service() throws DAOException {
        ...
        final List<SubvencionOrganization> list = service.basicQuery(SubvencionConstants.KEY,SubvencionOrganization.class);
    ...
    public void test02_Controller() {
        ...
        Assert.assertNotNull(wac.getBean("subvencionOrganizationController"));
    }
    ...
    public void test03_List() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionOrganizationController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    	...
    	String id ="300-TEST-000000524";
     	String item = " {\n" + 
    		    ...
    		    "  	   \"distritoTitle\": \"Alcobendas\",\n" +
     		    ...
     		    "  	   \"classification\": \"clasificacion-tipo-1\" \n" +  
    			"    }"; 	
         ...
         this.mockMvc.perform(MockMvcRequestBuilders.post(SubvencionOrganizationController.ADD)
    ...
    public void test07_Update() throws Exception {
    	String id ="300-TEST-000000524";
     	String item = " {\n" + 
     			"      \"id\":\"" +id+"\",\n" +
     			"      \"title\": \"Redondo y García S.A.xx\",\n" + 
     			"      \"url\": \"https://datos.madrid.es/FwFront/portal_egob/new/img/portal_logo_h.png\",\n" +
     		    "      \"municipioId\": \"28006\",\n" +
     		    "  	   \"municipioTitle\": \"Alcobendas\",\n" +
     		    "      \"distritoId\": \"28006\",\n" +
    		    "  	   \"distritoTitle\": \"Alcobendas\",\n" +
     		    "      \"streetAddress\": \"CL BLAS DE OTERO 4xxx\",\n" +
     		    "      \"postalCode\": \"28100\",\n" +
     		    "      \"portalId\": \"PORTAL000101\",\n" +
     		    "      \"contactPointFaxNumber\": \"1123333333x\",\n" +
     		    "      \"contactPointEmail\": \"xxpepe@botello.com\",\n" +
     		    "      \"contactPointTelephone\": \"xxxEl fax no funciona llamar a 1123333335\",\n" +
     		    "  	   \"contactPointTitle\": \"xxxRedondo y García S.A.\", \n" +  
     		    "  	   \"classification\": \"clasificacion-tipo-2\" \n" +  
    			"    }";  	 
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put(SubvencionOrganizationController.ADD+"/"+id)
        		.contentType(MediaType.APPLICATION_JSON)
    	        .content(itemUPDATE))	
    ...
    public void test10_Record() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionOrganizationController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))	
    ...
    public void test11_Record_HEAD() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.head(SubvencionOrganizationController.ADD+"/"+id+".json")
        		.contentType(MediaType.APPLICATION_JSON))
	        .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void test15_List_HEAD() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(SubvencionOrganizationController.LIST+".json")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_RDF() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(SubvencionOrganizationController.LIST+".rdf")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    
    @Test    
    public void test16_List_HEAD_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.head(SubvencionOrganizationController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    
    @Test    
    public void test17_List_303() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionOrganizationController.LIST)).andExpect(MockMvcResultMatchers.status().is(303));
    }
    ...
    public void test18_Post_Transform() throws Exception {
    	...
    	this.mockMvc.perform(MockMvcRequestBuilders.post(SubvencionOrganizationController.TRANSFORM)
        		.contentType(MediaType.APPLICATION_JSON)
    ...
    public void test20_Database_and_vocabulary() throws Exception {
    	...
    	Field[] declaredFields = (SubvencionOrganization.class).getDeclaredFields();
    ...
    public void test21_List_Sort_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionOrganizationController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    @Test    
    public void test22_List_Sort_400() throws Exception {
    	String sort="?sort=-id,erroneo";
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionOrganizationController.LIST+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(400));
    }
    ...
    public void test23_List_Distinct_200() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(SubvencionOrganizationController.SEARCH_DISTINCT+".json"+sort)).andExpect(MockMvcResultMatchers.status().is(200));
    }
    
    
    @Test
    public void test25_List_Formatos_200() throws Exception {    	    	
    	boolean checkAllFormats=TestUtils.checkFormatURIs(SubvencionOrganizationController.LIST, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }
    
    @Test
    public void test26_List_RDF_200() throws Exception {    	
    	String theURI = TestUtils.checkRDFURI(this.mockMvc,SubvencionOrganizationController.LIST);        
    ...
    public void test27_Record_Formatos_200() throws Exception {    	    	
    	...
    	boolean checkAllFormats=TestUtils.checkFormatURIs(SubvencionOrganizationController.LIST+"/"+id, mockMvc);
    	assertTrue(checkAllFormats);    	    	
    }

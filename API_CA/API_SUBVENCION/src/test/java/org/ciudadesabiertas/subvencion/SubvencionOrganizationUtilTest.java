 ...
 *
 */
public class SubvencionOrganizationUtilTest
{
	...
	public void constructorCopia() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		...
		SubvencionOrganization mappedObj = mapper.readValue(testJSON, SubvencionOrganization.class);
		SubvencionOrganization organization = new SubvencionOrganization(mappedObj);
	...
	public void constructorCampos() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		...
		SubvencionOrganization CallejeroTramo = new SubvencionOrganization(mappedObj, listaCampos);
